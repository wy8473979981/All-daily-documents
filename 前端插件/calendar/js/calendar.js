// 关于月份： 在设置时要-1，使用时要+1
//http://note.youdao.com/noteshare?id=ec751b619f1e754be96306cf54477c1d&sub=3F31DA26EF13445093DF8EA5BA6CBCC3
$(function () {
  ...
  Calendar.prototype = {
    ...
    showCalendar: function () { // 输入数据并显示
      ...
      this.$calendarTitle_text.text(year + '/' + dateStr.substr(4, 2));
			debugger
			//$calendarDate_item 是所有的 li 节点 this.$calendarDate_item = this.$calendar_date.find('.item');
    ...
    constructor: Calendar//http://note.youdao.com/noteshare?id=54ef4791d11734dfd59cfa3d6156d07d&sub=AD4DE38782994B0096924FC10B31272A
    //这里是直接修改了prototype，而不是在prototype上加方法；为了使构造函数的实例的创建者保持正确的引用，就要用这句代码来修正引用
  };
	
	//参考文章http://note.youdao.com/noteshare?id=c1075d6a4dd31aebaf25fca0d9ea660f&sub=A4A96EAEEA51401299D63DA4E557CD5A
  $.fn.calendar = function (options) {//jq的插件机制，calender扩展为jq插件了
  	//这里的this指向这个$('#calendar')节点
