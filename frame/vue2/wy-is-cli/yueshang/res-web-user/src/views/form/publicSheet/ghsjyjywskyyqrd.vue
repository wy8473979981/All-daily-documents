<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24" class="top-row">
        ...
        <div class="d-min">
          ...
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.reason, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.reason" @change="reasonChange">
              ...
              <el-radio label="5">
                赴外培训
                <el-tooltip class="item" :value="form.bizEntityJson.reason == 5 && !form.bizEntityJson.disabled && !$route.query.id ? true : false" effect="dark" content="附件中需上传赴外申请网批截图" placement="top-start">
                  <i class="el-icon-warning"></i>
                </el-tooltip>
              </el-radio>
              <el-radio label="4">
      ...
      <el-col v-if="form.bizEntityJson.reason == 2 || form.bizEntityJson.reason == 5" :span="24" class="right-col">
