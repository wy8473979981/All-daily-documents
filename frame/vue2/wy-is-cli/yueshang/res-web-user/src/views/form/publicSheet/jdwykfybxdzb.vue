<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
      <el-row :gutter="24" class="top-row green-row">
        <dl-col :span="24" place="right">
            <d-radio-group-string
              ...
              :nameList="[{label:'酒店总部',name:'companyHotel2'},
                          {label:'租赁公司',name:'companyHotel3'}
                        ]"
            />
          </dl-col>

          <dl-col :span="24" title="预算:" :novalue="form.bizEntityJson.positionLevels2 != 'true' && form.bizEntityJson.extraBudgetary != 'true'" place="right">
            <d-radio-group-string
              v-model="form.bizEntityJson"
              :nameList="[{label:'预算内',name:'positionLevels2'},
                          {label:'预算外',name:'extraBudgetary'}
                        ]"
            />
          </dl-col>

          <dl-col :span="24" :novalue="form.bizEntityJson.positionLevel1 != 'true' && form.bizEntityJson.positionLevel2 != 'true'&& form.bizEntityJson.positionLevel3 != 'true' && form.bizEntityJson.positionLevel4 != 'true' && form.bizEntityJson.positionLevel5 != 'true'" place="right">
            <d-radio-group-string
              v-model="form.bizEntityJson"
              :nameList="[{label:'执行董事',name:'positionLevel1'},
                          {label:'集团总经理',name:'positionLevel2'},
                          {label:'总经理级',name:'positionLevel3'},
                          {label:'部门负责人（非总经理级）',name:'positionLevel4'},
      ...
      <select-scene :open="showScene && !form.bizEntityJson.disabled" :plate="4" @close="closeScene"></select-scene>
...
export default {
  ...
  methods: {
    ...
    async yykCheck() {
      ...
      if ((this.$route.query.costBxSceneConfigId == 'A6FDB7A2FB2FF921E0530D03FB0A9A2A' || this.form.bizEntityJson.costBxSceneConfigId =='A6FDB7A2FB2FF921E0530D03FB0A9A2A') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('汽车日常运营费报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'A6FDB7A2FB2DF921E0530D03FB0A9A2A' || this.form.bizEntityJson.costBxSceneConfigId =='A6FDB7A2FB2DF921E0530D03FB0A9A2A') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('办公费报销金额必须小于等于一万元')
        return false
      }

      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE3640A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE3640A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('汽车日常运营费报销金额必须小于等于一万元')
        return false
      }

      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE3610A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE3610A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('办公费报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE34A0A40E0530543FB0AD556' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE34A0A40E0530543FB0AD556') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('清洁卫生费报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE34A0A40E0576543FB0AD556' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE34A0A40E0576543FB0AD556') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('修理费用报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE36C0A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE36C0A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('制服费报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE3400A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE3400A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB不可预计费用报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE32E0A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE32E0A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费用办公室装饰报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE33D0A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE33D0A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费车辆使用费报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE32F0A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE32F0A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费电话费及网络报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE33F0A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE33F0A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费其他杂费报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE3340A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE3340A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费杀虫报销金额必须小于等于一万元')
        return false
      }
      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE3360A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE3360A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费试餐及调研费报销金额必须小于等于一万元')
        return false
      }

      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE33B0A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE33B0A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费洗涤清洁用品报销金额必须小于等于一万元')
        return false
      }

      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE3320A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE3320A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费印刷及办公用品报销金额必须小于等于一万元')
        return false
      }

      if ((this.$route.query.costBxSceneConfigId == 'ABF7CA7DE3390A40E0530D03FB0AD5A7' || this.form.bizEntityJson.costBxSceneConfigId =='ABF7CA7DE3390A40E0530D03FB0AD5A7') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
        this.$message.error('POB办公费运输搬运费报销金额必须小于等于一万元')
        return false
      }
