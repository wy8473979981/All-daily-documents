    ...
    export default {
        ...
        created() {
            if (!this.$route.query.id) {
                ...
                this.$set(this.form.bizEntityJson, 'receivingUnit', '社保管理中心')
        ...
        methods: {
            ...
            remoteMethod2(query) {
                ...
                if (query) {
                    this.loading = true
                    this.$approval.queryActionIdBySecurity(param).then(res => {
                        if(res.code == 1) {
                            if (res.data.length > 0) {
            ...
            actionIdChange(val) {
                ...
                this.$approval.queryActionListBySecurity(param).then(res => {
            ...
            async gjjCheck() {
                ...
                if(isMainData == true ){
                    ...
                    let result = await this.$approval.findMoreBudgetUsedDetail(param)
                    if(!result){
                        checkMoney = true;
                    }else {
                        alert(result);
