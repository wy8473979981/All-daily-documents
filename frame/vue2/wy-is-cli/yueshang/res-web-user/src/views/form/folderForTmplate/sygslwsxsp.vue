// 商业公司例外事项审批  宝龙地产/商业/商业公司/01-企业管理/其他
        ...
        <div class="d-min">
          ...
          <div class="d-red" :class="{novalue:!form.bizEntityJson.type}">
            <el-radio-group v-model="form.bizEntityJson.type">
              <el-radio :label="'0'">重资产项目</el-radio>
              <el-radio :label="'1'">轻资产项目</el-radio>
              <el-radio :label="'2'">收购公司</el-radio>
              <el-radio :label="'3'">住宅物业</el-radio>
            </el-radio-group>
          </div>
        </div>
      </el-col>
