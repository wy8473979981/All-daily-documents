<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row v-if="isShow1" gutter="24">
      ...
      <dl-col :span="12" title="变更类型" place="right">
        <el-input v-model="form.bizEntityJson.alterType" readonly/>
      </dl-col>
      <dl-col :span="12" title="合同名称">
        <el-button @click="openUrl(form.bizEntityJson.contractname)" type="text" size="mini">合同名称</el-button>
      </dl-col>
      <dl-col :span="12" title="乙方" place="right">
        <el-input v-model="form.bizEntityJson.yfprovidername" readonly/>
      </dl-col>
      <dl-col :span="12" title="面积">
        <el-input v-model="form.bizEntityJson.area" readonly/>
      </dl-col>
      <dl-col :span="12" title="招标报价模式" place="right">
        <el-input v-model="form.bizEntityJson.biddingMode" readonly/>
      </dl-col>
      <dl-col :span="12" title="甲方委托部门">
        <el-input v-model="form.bizEntityJson.jfEntrustedDept" readonly/>
      </dl-col>
      <dl-col :span="12" title="甲方经办人" place="right">
        <el-input v-model="form.bizEntityJson.jfagent" readonly/>
      </dl-col>
      <dl-col :span="12" title="咨询费用计算规则">
        <el-input v-model="form.bizEntityJson.consultFeeCalcRules" readonly/>
      </dl-col>
      <dl-col :span="12" title="咨询费比例" place="right">
        <el-input v-model="form.bizEntityJson.consultationCostRatio" readonly/>
      </dl-col>
      <dl-col :span="12" title="预估咨询费(含税)元">
        <el-input v-model="form.bizEntityJson.ygConsultationCost" readonly/>
      </dl-col>
    ...
    <el-row v-if="isShow2" gutter="24">
      <dl-col :span="12" title="签发日期">
        <el-input v-model="form.bizEntityJson.issueDate" readonly/>
      </dl-col>
      <dl-col :span="12" title="要求执行日期" place="right">
        <el-input v-model="form.bizEntityJson.requiredExecDate" readonly/>
      </dl-col>
