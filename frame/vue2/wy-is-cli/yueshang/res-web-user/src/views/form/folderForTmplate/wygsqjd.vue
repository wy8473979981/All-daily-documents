...
<template>
    ...
    <table class="border-table nobg" style="margin-bottom:10px">
      ...
      <tr>
        <td :class="{required: !form.bizEntityJson.disabled}">
          <d-radio-group 
            :class="{novalue: !form.bizEntityJson.cityBoss && !form.bizEntityJson.cityLeader && !form.bizEntityJson.cityOther && !form.bizEntityJson.propertyLeader && !form.bizEntityJson.propertyOther,required: !form.bizEntityJson.disabled}"
            v-model="form.bizEntityJson" 
            :nameList="[{label:'城市公司第一负责人',name:'cityBoss'},
                        {label:'城市公司部门负责人',name:'cityLeader'},
                        {label:'城市公司其他人员',name:'cityOther'},
                        {label:'物业项目第一负责人',name:'propertyLeader'},
                        {label:'物业项目其他人员',name:'propertyOther'},
                      ]"
          />
        </td>
      </tr>
    ...
    <el-row :gutter="24" v-for="(property,index) in form.bizEntityJson.otherProperties" :key="index">
      ...
      <el-col :span="4">
        <div class="d-min" :class="{novalue: !property.totalDays, 'required': !form.bizEntityJson.disabled}">
          <el-input disabled v-model="property.totalDays"></el-input>
        </div>
      </el-col>
