  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24" class="top-row green-row">
      <el-col :span="24" class="red-box-fix">
        <div class="d-min">
          <span>类别</span>
          <div class="d-red right-col" :class="{'novalue': form.bizEntityJson.positionLevel1 != 'true' && form.bizEntityJson.positionLevel2 != 'true' && form.bizEntityJson.positionLevel3 != 'true'&& form.bizEntityJson.positionLevel4 != 'true'&& form.bizEntityJson.positionLevel5 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group 
      ...
      <el-col :span="24" class="red-box-fix">
        <div class="d-min">
          <span></span>
          <div class="d-red right-col" :class="{'novalue': form.bizEntityJson.companyHotel2 != 'true' && form.bizEntityJson.companyHotel3 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group 
              v-model="form.bizEntityJson" 
...
export default {
 ...
 created() {
    ...
    if (!this.$route.query.id) {
      ...
      this.$set(this.form.bizEntityJson, 'resAuthTypeCd', 'ZLGS_BX_FL_10')
