  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24">
      ...
      <el-col :span="24" class="right-col">
        <div class="d-min">
          <span>　</span>
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.dblDept, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.dblDept">
              <el-radio label="1">双线部门</el-radio>
              <el-radio label="0">非双线部门</el-radio>
            </el-radio-group>
          </div>
        </div>
      </el-col>
