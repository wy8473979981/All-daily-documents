...
<!-- 配套公司业务支出审批表 -->
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24" class="top-row blue-row">
      <el-col :span="24" class="title-col right-col blue-row">
        <h2>付款信息</h2>
      </el-col>
      <el-col :span="12">
        <div class="d-min">
      ...
      <el-col :span="12" class="right-col">
        <div class="d-min">
          <span>(大写)</span>
          <el-input :value="form.bizEntityJson.payAmtCapitalDesc" 
 readonly :placeholder="form.bizEntityJson.disabled ? '' : ''"></el-input>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="d-min">
    ...
    <dl-col :span="12" place="right"  class="show-print"/>

     <el-col :span="12" class="right-col no-print">
        <div class="d-min">
          <span>实际付款事由</span>
          <el-input v-model="form.bizEntityJson.factPayContentDesc" type="textarea" autosize :placeholder="form.bizEntityJson.disabled ? '' : '请输入'"></el-input>
        </div>
      </el-col>
     </el-row>
     <el-row class="margin-row top-row green-row">
      ...
      <div v-for="(item, index) in form.bizEntityJson.contractNoList" :key="index">
        <el-col :span="12" v-if="form.bizEntityJson.isBorrow == 'false'">
          <div class="d-min">
            <span>融资合同编号</span>
            <el-select
        ...
        <el-col :span="12" v-if="form.bizEntityJson.isBorrow == 'true'">
          <div class="d-min">
            <span>融资合同编号</span>
            <el-select
                v-if="!form.bizEntityJson.disabled"
