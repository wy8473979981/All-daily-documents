  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <table class="tl-row margin-table green-table">
      <tr>
        ...
        <td>
          <div :class="{'novalue': form.bizEntityJson.preType1 != 'true' && form.bizEntityJson.preType3 != 'true' && form.bizEntityJson.preType2 != 'true' && form.bizEntityJson.preType4 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group
                v-model="form.bizEntityJson"
                :nameList="[{label:'出差申请单',name:'preType1'},
                          {label:'效果图',name:'preType3'},
                          {label:'文本制作',name:'preType2'},
                          {label:'行政类费用及其他',name:'preType4'}]"
            />
          </div>
        </td>
        <td colspan="2" :style="{width: 12 / 24 * 100 + '%'}">
          <div v-if="form.bizEntityJson.preType1 == 'true'" :class="{'novalue': form.bizEntityJson.positionLevel1 != 'true' && form.bizEntityJson.positionLevel2 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group
                v-model="form.bizEntityJson"
                :nameList="[{label:'规划院院长',name:'positionLevel1'},
      ...
      <tr>
        ...
        <td>
          <div :class="{'novalue': form.bizEntityJson.inBudget != 'true' && form.bizEntityJson.extraBudgetary != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group
                v-model="form.bizEntityJson"
                :nameList="[{label:'预算内',name:'inBudget'},
    ...
    <!-- <el-row :gutter="24" class="top-row green-row">
      <el-col :span="12" class="red-box-fix">
        <div class="d-min">
          ...
          <div class="d-red" :class="{'novalue': form.bizEntityJson.preType1 != 'true'
                              && form.bizEntityJson.preType3 != 'true'
                              && form.bizEntityJson.preType2 != 'true'
                              && form.bizEntityJson.preType4 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group
                v-model="form.bizEntityJson"
                :nameList="[{label:'出差申请单',name:'preType1'},
                          {label:'效果图',name:'preType3'},
      ...
      <el-col :span="24" class="red-box-fix right-col">
        <div class="d-min d-checkbox">
          <span>预算</span>
          <div class="d-red"
               :class="{'novalue': form.bizEntityJson.inBudget != 'true'
                          && form.bizEntityJson.extraBudgetary != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group
                v-model="form.bizEntityJson"
                :nameList="[{label:'预算内',name:'inBudget'},
                          {label:'预算外',name:'extraBudgetary'}]"
