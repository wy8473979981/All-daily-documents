    ...
    <el-row :gutter="24">
        ...
        <div class="d-min">
          ...
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.unitType, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.unitType">
              ...
              <el-radio label="2">各事业部及置地</el-radio>
      ...
      <el-col :span="24" class="right-col">
        <div class="d-min">
          <span>
            所属项目
            <el-tooltip class="item" effect="dark" content="如是地产公司" placement="top-start">
              <i class="el-icon-warning"></i>
            </el-tooltip>
          </span>
          <el-input v-model="form.bizEntityJson.centerOrgName" @focus="showSearchOrg = true" readonly :placeholder="form.bizEntityJson.disabled ? '' : '请选择'"></el-input>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="d-min">
