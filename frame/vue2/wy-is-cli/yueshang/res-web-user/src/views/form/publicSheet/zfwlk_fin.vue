<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row class="padding-row">
        ...
        <dl-col v-if="(form.bizEntityJson.isLand == 'true' || form.bizEntityJson.isBusiness == 'true') && form.bizEntityJson.area2 == 'true' " :class="{'novalue': !form.bizEntityJson.receiveUnitName, 'required': !form.bizEntityJson.disabled}" :span="12" title="收款单位全称" place="right">
