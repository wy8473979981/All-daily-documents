<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row v-if="isShow1" gutter="24">
      ...
      <dl-col :span="24" title="单方口径及指标说明" :novalue="!form.bizEntityJson.dfCaliberDescription" place="right">
        <el-input v-model="form.bizEntityJson.dfCaliberDescription" :placeholder="form.bizEntityJson.disabled ? '' : '请输入'" :disabled="form.bizEntityJson.disabled"/>
      </dl-col>
    ...
    <el-row v-if="isShow5" gutter="24">
      <dl-col :span="24" place="table right">
        <el-table ref="table" :data="form.bizEntityJson.detail3" size="mini" border stripe
