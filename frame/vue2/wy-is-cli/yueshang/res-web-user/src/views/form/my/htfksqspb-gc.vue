<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row v-if="isShow1" gutter="24">
      ...
      <dl-col :span="12" title="应付金额" place="right">
        <el-input v-model="form.bizEntityJson.yfAmount" readonly/>
      </dl-col>
      <dl-col :span="12" title="其中扣款金额">
        <el-input v-model="form.bizEntityJson.deductAmount" readonly/>
      </dl-col>
      <dl-col :span="12" title="其中现金金额" place="right">
        <el-input v-model="form.bizEntityJson.cash" readonly/>
      </dl-col>
      <dl-col :span="12" title="其中冲账金额">
        <el-input v-model="form.bizEntityJson.strikeAmount" readonly/>
      </dl-col>
      <dl-col :span="12" title="其中商票金额" place="right">
        <el-input v-model="form.bizEntityJson.commercialPaperAmount" readonly/>
      </dl-col>
      <dl-col :span="12" title="其中甲供料金额">
        <el-input v-model="form.bizEntityJson.jgMaterialsAmount" readonly/>
      </dl-col>
      <dl-col :span="12" title="其中抵房金额" place="right">
        <el-input v-model="form.bizEntityJson.mortgage" readonly/>
      </dl-col>
      ...
      <dl-col :span="12" title="是否纳入保留">
        <el-radio-group v-model="form.bizEntityJson.isInFactoring">
          <el-radio label="true">是</el-radio>
          <el-radio label="false">否</el-radio>
        </el-radio-group>
      </dl-col>
      <dl-col :span="12" title="是否纳入隆辉商票" place="right">
        <el-radio-group v-model="form.bizEntityJson.isCommercialPaper">
          <el-radio label="true">是</el-radio>
          <el-radio label="false">否</el-radio>
        </el-radio-group>
      </dl-col>
      <dl-col :span="24" title="申请说明" place="right">
        <el-input v-model="form.bizEntityJson.applicationDescription" type="textarea" :autosize="{ minRows: 3}"
                  readonly/>
      </dl-col>
    </el-row>
    <el-row gutter="24" class="padding-row">
    ...
    <el-row v-if="isShow2" gutter="24">
      <dl-col :span="4" title="" place="title-auto" />
      <dl-col :span="5" title="税率(%)" place="title-auto"/>
      <dl-col :span="5" title="含税金额" place="title-auto"/>
      <dl-col :span="5" title="税额" place="title-auto"/>
      <dl-col :span="5" title="不含税金额" place="title-auto"/>
      ...
      <dl-col :span="4" title="累计上报产值" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="其中上期累计产值" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="其中本期上报产值" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="其中商票" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="其中抵房" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="本次扣款金额" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="其中扣款" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="其中冲账" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
      ...
      <dl-col :span="4" title="其中甲供料" place="title-auto" />
      <dl-col :span="5">
        <el-input v-model="form.bizEntityJson.company" readonly/>
      </dl-col>
      <dl-col :span="5">
    ...
    <el-row v-if="isShow5" gutter="24">
      <dl-col :span="24" place="table right">
        <el-table ref="table" :data="form.bizEntityJson.warrantyPlanList" size="mini" border stripe
                  header-row-class-name="table-header">
          <el-table-column label="序号" prop="zbjcode" align="center">
            <template slot-scope="detail">
              <el-input v-model="detail.row.zbjcode" readonly/>
            </template>
          </el-table-column>
          <el-table-column label="款项名称" prop="paymentname" align="center">
            <template slot-scope="detail">
              <el-input v-model="detail.row.paymentname" readonly/>
            </template>
          </el-table-column>
          <el-table-column label="含税金额" prop="paymentname" align="center">
            <template slot-scope="detail">
              <el-input v-model="detail.row.paymentname" readonly/>
            </template>
          </el-table-column>
          ...
          <el-table-column label="不含税金额" prop="zbAmountNoTax" align="center">
            <template slot-scope="detail">
              <el-input v-model="detail.row.zbAmountNoTax" readonly/>
            </template>
          </el-table-column>
          <el-table-column label="付款日期" prop="fkDate" align="center">
            <template slot-scope="detail">
              <el-input v-model="detail.row.fkDate" readonly/>
            </template>
          </el-table-column>
          <el-table-column label="付款说明" prop="paymentinfo" align="center">
            <template slot-scope="detail">
              <el-input v-model="detail.row.paymentinfo" readonly/>
            </template>
          </el-table-column>
        </el-table>
      </dl-col>
