...
<template>
    ...
    <table class="border-table nobg" style="margin-bottom:10px">
      ...
      <tr>
        <td  :class="{novalue: !form.bizEntityJson.positionLevel1 && !form.bizEntityJson.positionLevel4 && !form.bizEntityJson.positionLevel3 && !form.bizEntityJson.positionLevel2,required: !form.bizEntityJson.disabled}"> 
           <d-radio-group 
            v-model="form.bizEntityJson" 
            :nameList="[{label:'地产公司负责人',name:'positionLevel1'},
                        {label:'部门负责人（双线）',name:'positionLevel4'},
                        {label:'部门负责人（非双线）',name:'positionLevel3'},
