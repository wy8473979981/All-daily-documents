  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24">
        ...
        <div class="d-min">
          ...
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.approvalPath, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.approvalPath">
              <el-radio label="1">开发类</el-radio>
              <el-radio label="2">非开发类</el-radio>
            </el-radio-group>
          </div>
        </div>
      </el-col>
      <el-col :span="24" class="right-col">
        <div class="d-min">
          <span>　</span>
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.aboutRelatedDept, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.aboutRelatedDept">
      ...
      <el-col :span="24" class="right-col">
        <div class="d-min">
          ...
          <t-textarea class="t-textarea-auto" :class="{'novalue': !form.bizEntityJson.fileDesc, 'required': !form.bizEntityJson.disabled}" v-model="form.bizEntityJson.fileDesc" :placeholder="form.bizEntityJson.disabled ? '' : ''" :disabled="form.bizEntityJson.disabled"></t-textarea>
        </div>
      </el-col>
    </el-row>
