      ...
      if(res.code == 1){
        ...
        if (res.data.isReimburse == 1) {
          ...
          for(let index in res.data.detailList) {
            ...
            console.log('1111',res.data.detailList[index].realExecFlg == 1)
            // 实报实销
            if (res.data.detailList[index].realExecFlg == 1) {
              ...
              if (this.form.bizEntityJson.currencyAmt == 'CNY') {
                console.log(res.data.detailList[index].displayName)
                console.log((Number(res.data.detailList[index].agreeAmt) + Number(this.form.bizEntityJson.detailList[index].currentAmt) + Number(this.form.bizEntityJson.detailList[index].currentAmt2)).toFixed(2))
