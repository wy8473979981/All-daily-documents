<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row>
      ...
      <dl-col class="title-col" :span="3" place="right">
        <h2>主合同金额(进项税额)</h2>
      </dl-col>
      <div v-for="(item, index) in form.bizEntityJson.businessDetailList" :key="index">
        ...
        <el-col :span="3">
          <div class="d-min">
            <el-input v-model="item.bcsharetotaltax" readonly></el-input>
          </div>
        </el-col>
        <el-col :span="3">
          <div class="d-min">
            <el-input v-model="item.bcsharetotal" readonly></el-input>
          </div>
        </el-col>
        <el-col :span="3">
          <div class="d-min">
            <el-input v-model="item.bctaxtotal" readonly></el-input>
          </div>
        </el-col>
        <el-col :span="3">
          <div class="d-min">
