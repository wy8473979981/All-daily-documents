  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24" class="top-row green-row">
      <el-col :span="24" class="red-box-fix">
        <div class="d-min">
          <span>类别</span>
          <div class="d-red right-col" :class="{'novalue': form.bizEntityJson.positionLevel8 != 'true' && form.bizEntityJson.positionLevel9 != 'true' , 'required': !form.bizEntityJson.disabled}">
            <d-radio-group 
              v-model="form.bizEntityJson" 
              :nameList="[{label:'第一负责人',name:'positionLevel8'},
      ...
      <el-col :span="24" class="red-box-fix">
        <div class="d-min">
          ...
          <div class="d-red right-col" :class="{'novalue': form.bizEntityJson.positionLevel1 != 'true' && form.bizEntityJson.positionLevel2 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group 
              v-model="form.bizEntityJson" 
              :nameList="[{label:'自营酒店',name:'positionLevel1'},
                          {label:'委托酒店',name:'positionLevel2'}]"
            />
          </div>
        </div>
      </el-col>
...
export default {
 ...
 created() {
    ...
    if (!this.$route.query.id) {
      ...
      this.$set(this.form.bizEntityJson, 'resAuthTypeCd', 'XSJD_BX_FL_10')
