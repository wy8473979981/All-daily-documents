<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24">
        ...
        <dl-col :span="24" :novalue="form.bizEntityJson.area10 != 'true' && form.bizEntityJson.area11 != 'true' && form.bizEntityJson.area12" place="right">
            <d-radio-group-string
            v-model="form.bizEntityJson" 
            :nameList="[{label:'项目公司内部',name:'area10'},
                        {label:'事业部',name:'area11'},
                        {label:'总部',name:'area12'}
                        ]"
            />
        </dl-col>
    </el-row>
