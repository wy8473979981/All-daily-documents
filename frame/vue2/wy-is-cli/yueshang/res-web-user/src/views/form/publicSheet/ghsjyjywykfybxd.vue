<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <select-scene :open="showScene && !form.bizEntityJson.disabled" :plate="10" @close="closeScene"></select-scene>
...
export default {
  ...
  created() {
    if (!this.$route.query.id) {
      ...
      if(this.$route.query.costBxSceneConfigId == '8DC4CB18DFC1ACA8E0530D03FB0A3BAF'){
        this.addList()
        this.addList()
        this.addList()
        this.addList()
  ...
  methods: {
    ...
    selectSubjectBySceneId(id, index){
      ...
      this.$approval.selectSubjectBySceneId(param).then(res => {
         if(res.code == 1 && res.data) {
          ...
          this.$set(this.form.bizEntityJson.billList[index], 'billContent', (this.$route.query.costBxSceneConfigId == '8DC4CB18DFC1ACA8E0530D03FB0A3BAF' || this.form.bizEntityJson.costBxSceneConfigId =='8DC4CB18DFC1ACA8E0530D03FB0A3BAF') ? '外包外服费' : res.data.accountName)
    ...
    async yykCheck() {
      ...
      if ((this.$route.query.costBxSceneConfigId == '8DC4CB18DFD8ACA8E0530D03FB0A3BAF' || this.form.bizEntityJson.costBxSceneConfigId =='8DC4CB18DFD8ACA8E0530D03FB0A3BAF') && Number(this.form.bizEntityJson.totalAmt) > 10000) {
