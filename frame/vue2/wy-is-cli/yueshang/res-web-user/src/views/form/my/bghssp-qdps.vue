<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row v-if="isShow1" gutter="24">
      ...
      <dl-col :span="12" title="定标编号">
        <el-button @click="openUrl(form.bizEntityJson.changeApprovalFeeURL)" type="text" size="mini">定标编号</el-button>
      </dl-col>
      <dl-col :span="12" title="工程" place="right">
        <el-input v-model="form.bizEntityJson.dcApprovalFee" readonly/>
      </dl-col>
      <dl-col :span="12" title="招标编号">
        <el-input v-model="form.bizEntityJson.subject" readonly/>
      </dl-col>
      <dl-col :span="12" title="中标单位" place="right">
        <el-input v-model="form.bizEntityJson.dcApprovalFee" readonly/>
      </dl-col>
      <dl-col :span="12" title="不含税中标价(元)">
        <el-input v-model="form.bizEntityJson.cbApprovalFee" readonly/>
      </dl-col>
      <dl-col :span="12" title="单方造价(元/平方米)" place="right">
        <el-input v-model="form.bizEntityJson.nuclearNo" readonly/>
      </dl-col>
      ...
      <dl-col :span="24"  title="含税总价" place="right">
