...
<template>
    ...
    <table class="border-table nobg" style="margin-bottom:10px">
      ...
      <tr>
        <td :class="{novalue: !form.bizEntityJson.positionLevel14 && !form.bizEntityJson.positionLevel10 && !form.bizEntityJson.positionLevel11 && !form.bizEntityJson.positionLevel3 && !form.bizEntityJson.positionLevel4,required: !form.bizEntityJson.disabled}"> 
           <d-radio-group 
            v-model="form.bizEntityJson" 
            :nameList="[{label:'副总裁（主席办）',name:'positionLevel14'},
                        {label:'副总裁',name:'positionLevel10'},
                        {label:'中心负责人',name:'positionLevel11'},
      ...
      <el-col :span="4">
        <div class="d-min" :class="{novalue: !property.beginDate, 'required': !form.bizEntityJson.disabled}">
          <el-date-picker
            ...
            :default-value="new Date(new Date(new Date().toLocaleDateString()).getTime()+9*60*60*1000)"
      ...
      <el-col :span="4">
        <div class="d-min" :class="{novalue: !property.endDate, 'required': !form.bizEntityJson.disabled}">
          <el-date-picker
            ...
            value-format="yyyy-MM-dd HH:mm:ss"
            format="yyyy-MM-dd HH"
            :default-value="new Date(new Date(new Date().toLocaleDateString()).getTime()+18*60*60*1000)"
