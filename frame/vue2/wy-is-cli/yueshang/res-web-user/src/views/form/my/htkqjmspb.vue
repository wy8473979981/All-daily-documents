<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row v-if="isShow1" gutter="24">
      <dl-col :span="24" title="查看减免单据" class="right-col">
        <el-button @click="openUrl(form.bizEntityJson.deductionUrl)" type="text" size="mini">查看减免单据</el-button>
      </dl-col>
      <dl-col :span="12" title="减免编号" >
        <el-input v-model="form.bizEntityJson.deductionno" readonly/>
      </dl-col>
      <dl-col :span="12" title="减免主题" place="right">
      ...
      <dl-col :span="12" title="扣款金额">
        <el-input v-model="form.bizEntityJson.deductAmount" readonly/>
      </dl-col>
      <dl-col :span="12" title="减免金额" place="right">
    ...
    <el-row v-if="isShow2" gutter="24">
      <dl-col :span="24" place="table right">
        <el-table ref="table" :data="form.bizEntityJson.deductionDetailsList" size="mini" border stripe
          ...
          <el-table-column label="减免说明" prop="exemptionNotes" align="center">
            <template slot-scope="detail">
