    ...
    <el-row :gutter="24" class="top-row">
      <el-col :span="24" class="red-box-fix right-col">
        <div class="d-min d-checkbox">
          <span></span>
          <div class="d-red" :class="{'novalue': form.bizEntityJson.positionLevel3 != 'true'
      ...
      <el-col :span="24" class="red-box-fix right-col">
        <div class="d-min d-checkbox">
          <span></span>
          <div class="d-red" :class="{'novalue': form.bizEntityJson.ctype1 != 'true'
                          && form.bizEntityJson.ctype2 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group
                v-model="form.bizEntityJson"
