...
<template>
    ...
    <el-row>
      <d-col place="top" title="" row="1">
        <el-checkbox v-model="form.bizEntityJson.department1">事业一部</el-checkbox>
        <el-checkbox v-model="form.bizEntityJson.department2">事业二部</el-checkbox>
        <el-checkbox v-model="form.bizEntityJson.department3">置地</el-checkbox>
        <el-checkbox v-model="form.bizEntityJson.department4">浙江事业部</el-checkbox>
        <el-checkbox v-model="form.bizEntityJson.department7">安徽事业部</el-checkbox>
        <el-checkbox v-model="form.bizEntityJson.company66">广东事业部</el-checkbox>
      </d-col>
      <d-col title="中心/公司" row="1" :novalue="!form.bizEntityJson.centerOrgName">
        <el-input :class="{'novalue': !form.bizEntityJson.centerOrgName, 'required': !form.bizEntityJson.disabled}" v-model="form.bizEntityJson.centerOrgName" @focus="showSearchOrg = true" readonly></el-input>
      </d-col>
      <d-col place="right" title="部门" :novalue="!form.bizEntityJson.deptName">
    ...
    <div style="margin-top:20px;position:relative"  v-for="(item,index) in form.bizEntityJson.detailList" :key="index">
      ...
      <el-row>
        ...
        <d-col  title="加班开始时间" :novalue="!item.fromTime">
          <el-time-picker
            style="width:100%"
            :picker-options="{
