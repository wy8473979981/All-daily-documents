  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24" class="top-row">
        ...
        <div class="d-min">
          ...
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.businessDivision, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.businessDivision">
              <el-radio label="0">商业集团</el-radio>
              <el-radio label="1">区域公司</el-radio>
            </el-radio-group>
          </div>
        </div>
      </el-col>
      <el-col :span="12" class="right-col">
        <div class="d-min">
          <div v-if="form.bizEntityJson.businessDivision != undefined" class="d-red" :class="{'novalue': !form.bizEntityJson.positionLevel, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.positionLevel">
              <el-radio v-if="form.bizEntityJson.businessDivision === '0'" label="0">管理层/中心总</el-radio>
              <el-radio v-if="form.bizEntityJson.businessDivision === '1'" label="0">区域总</el-radio>
        ...
        <div class="d-min">
          ...
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.reason, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.reason" @change="reasonChange">
              ...
              <el-radio label="2">
                机器故障
                <el-tooltip class="item" :value="form.bizEntityJson.reason == 2 && !form.bizEntityJson.disabled && !$route.query.id ? true : false" effect="dark" content="附件中需上传故障截图" placement="top-start">
      ...
      <el-col v-if="form.bizEntityJson.reason == 2" :span="24" class="right-col">
