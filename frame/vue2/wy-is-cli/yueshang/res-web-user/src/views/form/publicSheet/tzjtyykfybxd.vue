          ...
          <div class="d-red" :class="{'novalue': form.bizEntityJson.preType1 != 'true'
            ...
            <d-radio-group
                ...
                :nameList="[{label:'出差申请单',name:'preType1'},
                          {label:'A级接待',name:'preType2'},
                          {label:'B-C级接待',name:'preType3'}]"
            />
          </div>
        </td>
        <td colspan="2" :style="{width: 12 / 24 * 100 + '%'}">
          <div v-if="form.bizEntityJson.preType1 == 'true'" class="d-red"
               :class="{'novalue': form.bizEntityJson.positionLevel1 != 'true'
                          && form.bizEntityJson.positionLevel2 != 'true', 'required': !form.bizEntityJson.disabled}">
            <d-radio-group
                v-model="form.bizEntityJson"
                :nameList="[{label:'中心总经理',name:'positionLevel1'},
                          {label:'普通人员',name:'positionLevel2'}]"
            />
          </div>
        </td>
      </tr>
