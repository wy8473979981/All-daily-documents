    ...
    <el-row :gutter="24">
        ...
        <div class="d-min">
          ...
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.unitType, 'required': !form.bizEntityJson.disabled}">
            <el-radio-group v-model="form.bizEntityJson.unitType">
              <el-radio label="4">城市公司</el-radio>
              <el-radio label="5">物业项目</el-radio>
            </el-radio-group>
          </div>
        </div>
      </el-col>
      ...
      <el-col :span="24" class="right-col">
        <div class="d-min" :class="form.bizEntityJson.disabled ? '' : 'required'">
          <div class="d-red" :class="{'novalue': !form.bizEntityJson.officialSeal && !form.bizEntityJson.legalPersonSeal && !form.bizEntityJson.financeSeal && !form.bizEntityJson.licenseSeal && !form.bizEntityJson.chairmanSeal && !form.bizEntityJson.presidentSeal && !form.bizEntityJson.executiveDirectorSeal, 'required': !form.bizEntityJson.disabled}">
            ...
            <el-checkbox v-model="form.bizEntityJson.licenseSeal">公司证照</el-checkbox>
            <el-checkbox v-model="form.bizEntityJson.chairmanSeal">董事局主席证件原件</el-checkbox>
            <el-checkbox v-model="form.bizEntityJson.presidentSeal">总裁证件原件</el-checkbox>
            <el-checkbox v-model="form.bizEntityJson.executiveDirectorSeal">执行董事证件原件</el-checkbox>
          </div>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    validate() {
      ...
      if(!this.form.bizEntityJson.officialSeal && !this.form.bizEntityJson.legalPersonSeal && !this.form.bizEntityJson.financeSeal && !this.form.bizEntityJson.licenseSeal && !this.form.bizEntityJson.chairmanSeal && !this.form.bizEntityJson.presidentSeal && !this.form.bizEntityJson.executiveDirectorSeal) return this.$message.error('请选择一项印鉴种类'), false
