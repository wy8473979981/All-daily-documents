// 法律事务审批表 宝龙地产/地产/04-行政人事/03-行政管理/04-通用
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row :gutter="24">
      <el-col :span="24" class="right-col">
        <div class="d-min" :class="form.bizEntityJson.disabled ? '' : 'required'">
          <span>案例编号</span>
          <el-select
            :class="{novalue:!form.bizEntityJson.caseNo}"
            ...
            <el-option
              ...
              :value="item.caseCode">
              <el-row>
                <el-col>{{item.caseCode}}{{item.caseName}}</el-col>
              </el-row>
            </el-option>
          </el-select>
        </div>
    ...
    <el-row :gutter="24">
      <el-col :span="12">
        <div class="d-min" :class="form.bizEntityJson.disabled ? '' : 'required'">
          <span>律师费(元)</span>
          <el-input :class="{novalue:!form.bizEntityJson.lawyerFee}" v-model="form.bizEntityJson.lawyerFee" type="number"></el-input>
        </div>
      </el-col>
      <el-col :span="12" class="right-col">
        <div class="d-min" :class="form.bizEntityJson.disabled ? '' : 'required'">
          <span>诉讼费(元)</span>
          <el-input :class="{novalue:!form.bizEntityJson.litigationCosts}" v-model="form.bizEntityJson.litigationCosts" type="number"></el-input>
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="24">
    ...
    <el-row :gutter="24">
      ...
      <el-col :span="8" class="right-col">
        <div class="d-min" :class="form.bizEntityJson.disabled ? '' : 'required'">
          <span>诉讼标的额(元)</span>
          <el-input :class="{novalue:!form.bizEntityJson.litigationAmount}" v-model="form.bizEntityJson.litigationAmount" type="number"></el-input>
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="24">
    ...
    <el-row :gutter="24">
     ...
     <el-row :gutter="24">
      <el-col :span="24" class="right-col" :class="{litigationIds: form.mapEdit.litigationIds}">
        <div class="d-min">
...
export default {
  ...
  methods: {
    ...
    changeProject(val) {
      const value = this.options.find(e => e.caseCode == val)
      this.$set(this.form.bizEntityJson,'attorney',value.attorney)
      this.$set(this.form.bizEntityJson,'caseClassify',value.caseClassify)
      this.$set(this.form.bizEntityJson,'caseDescription',value.caseDescription)
      this.$set(this.form.bizEntityJson,'caseMode',value.caseMode)
      this.$set(this.form.bizEntityJson,'caseName',value.caseName)
      this.$set(this.form.bizEntityJson,'commissionType',value.commissionType)
      this.$set(this.form.bizEntityJson,'defendant',value.defendant)
      this.$set(this.form.bizEntityJson,'litigationAmount',value.litigationAmount)
      this.$set(this.form.bizEntityJson,'plaintiff',value.plaintiff)
      this.$set(this.form.bizEntityJson,'projectCd',value.projectCd)
      this.$set(this.form.bizEntityJson,'projectName',value.projectName)
      this.$set(this.form.bizEntityJson,'prosecutionDate',value.prosecutionDate)
      this.options = []
      this.$set(this.form.bizEntityJson,'caseNo',value.caseCode)
    },
