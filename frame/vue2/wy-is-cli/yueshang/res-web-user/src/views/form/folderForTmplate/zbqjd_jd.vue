...
<template>
    ...
    <table class="border-table nobg" style="margin-bottom:10px">
      ...
      <tr>
        <td :class="{novalue: !form.bizEntityJson.positionLevel1 && !form.bizEntityJson.positionLevel2 && !form.bizEntityJson.positionLevel3 && !form.bizEntityJson.positionLevel4 && !form.bizEntityJson.positionLevel5,required: !form.bizEntityJson.disabled}"> 
           <d-radio-group 
