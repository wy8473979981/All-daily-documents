<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    ...
    <el-row v-if="isShow1" gutter="24">
      ...
      <dl-col :span="12" title="变更单号">
        <el-input v-model="form.bizEntityJson.alterNo" readonly/>
      </dl-col>
      <dl-col :span="12" title="变更名称" place="right">
      ...
      <dl-col :span="12" title="变更提出方" place="right">
        <el-input v-model="form.bizEntityJson.reportPerson" readonly/>
      </dl-col>
      ...
      <dl-col :span="12" title="本次预估金额（含税）元">
        <el-input v-model="form.bizEntityJson.estimateAmount" readonly/>
      </dl-col>
      <dl-col :span="12" title="本次预估费用变更比例%" place="right">
      ...
      <dl-col :span="12" title="乙方" place="right">
        <el-input v-model="form.bizEntityJson.yfprovidername" readonly/>
      </dl-col>
      <dl-col :span="24" title="已确认合同总价(含税)" place="right">
        <el-input v-model="form.bizEntityJson.conftotalcontractprice" readonly/>
      </dl-col>
      <dl-col :span="12" title="合同原价(含税)元">
        <el-input v-model="form.bizEntityJson.orContractPrice" readonly/>
      </dl-col>
      <dl-col :span="12" title="补充协议价(含税)元" place="right">
        <el-input v-model="form.bizEntityJson.supplementaryPrice" readonly/>
      </dl-col>
      <dl-col :span="12" title="累计已审变更费(含税)">
        <el-input v-model="form.bizEntityJson.projname" readonly/>
      </dl-col>
      <dl-col :span="12" title="已发生变更比例%" place="right">
        <el-input v-model="form.bizEntityJson.proportionChanged" readonly/>
      </dl-col>
      <dl-col :span="12" title="本次设计分页增加后预估总合同总价(含税)元">
        <el-input v-model="form.bizEntityJson.ygContractPrice" readonly/>
      </dl-col>
      <dl-col :span="12" title="本次设计费用增加后累计变更比例%" place="right">
        <el-input v-model="form.bizEntityJson.cumChangeRatio" readonly/>
      </dl-col>
      <dl-col :span="12" title="是否设计拆改">
        <el-input v-model="form.bizEntityJson.isInvolved" readonly/>
      </dl-col>
      <dl-col :span="12" title="是否已施工" place="right">
        <el-input v-model="form.bizEntityJson.isConstructed" readonly/>
      </dl-col>
      <dl-col :span="12" title="是否滞后">
        <el-input v-model="form.bizEntityJson.isDelay" readonly/>
      </dl-col>
      <dl-col :span="12" title="是否回收" place="right">
    ...
    <el-row v-if="isShow2" gutter="24">
      <dl-col :span="12" title="提出时间">
        <el-input v-model="form.bizEntityJson.reportDate" readonly/>
      </dl-col>
      <dl-col :span="12" title="预计完成日期" place="right">
        <el-input v-model="form.bizEntityJson.estCompletionDate" readonly/>
      </dl-col>
      <dl-col :span="12" title="是否后补立项">
        <el-input v-model="form.bizEntityJson.reportDate" readonly/>
      </dl-col>
      <dl-col :span="12" title="是否设计其它合同扣减" place="right">
        <el-input v-model="form.bizEntityJson.estCompletionDate" readonly/>
      </dl-col>
