f<template>
  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <table class="tl-row margin-table green-table">
      <tr>
        <td class="title">
          <span>报销类别</span>
        </td>
        ...
        <td colspan="2" :style="{width: 12 / 24 * 100 + '%'}">
      ...
      <tr v-if="isListingFees || (form.bizEntityJson.disabled && (form.bizEntityJson.attachPhoto == 'true'
                              || form.bizEntityJson.resourceDepartment == 'true'))">
        <td class="title">
          <span>上市费用责任归属</span>
        </td>
        <td>
    ...
    <el-row :gutter="24" class="margin-row blue-row">
      <el-col :span="24" class="topRight-col">
        <div class="d-min">
          ...
          <el-input v-model="form.bizEntityJson.totalAmt" readonly maxlength="15" v-limit-number="2" @focus="toFixedFocus" @change="toFixedBlur"></el-input>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="d-min">
