...
<template>
    ...
    <table class="border-table nobg" style="margin-bottom:10px">
      ...
      <tr>
        <td :class="{novalue: !form.bizEntityJson.newPositionLevel1 && !form.bizEntityJson.newPositionLevel2 && !form.bizEntityJson.newPositionLevel3,required: !form.bizEntityJson.disabled}">
          <d-radio-group 
            v-model="form.bizEntityJson"
            :nameList="[{label:'事业部负责人',name:'newPositionLevel1'},
