...
<template>
    ...
    <table class="border-table nobg" style="margin-bottom:10px">
      <tr>
        ...
        <td :class="{novalue: !form.bizEntityJson.isProjectType,required: !form.bizEntityJson.disabled}"> <el-radio-group @change="changeType" v-model="form.bizEntityJson.isProjectType">
          <el-radio class="line-radio" :label="'1'">B类项目</el-radio>
          <el-radio class="line-radio" :label="'2'">非B类项目</el-radio>
        </el-radio-group></td>
      </tr>
      <tr>
        ...
        <td :class="{novalue: !form.bizEntityJson.dayType,required: !form.bizEntityJson.disabled}"> <el-radio-group v-model="form.bizEntityJson.dayType">
      ...
      <tr>
        <td> 
           <d-radio-group 
            :class="{novalue: !form.bizEntityJson.positionLevel1 && !form.bizEntityJson.positionLevel3 && !form.bizEntityJson.positionLevel7 && !form.bizEntityJson.positionLevel8,required: !form.bizEntityJson.disabled}"
            v-model="form.bizEntityJson" 
            :nameList="form.bizEntityJson.isProjectType !== '1' ? [{label:'总经理',name:'positionLevel1'},
                        {label:'其他人员',name:'positionLevel3'},
                        {label:'副总经理/部门负责人（双线）',name:'positionLevel7'},
                        {label:'副总经理/部门负责人（非双线）',name:'positionLevel8'},
    ...
    <el-row :gutter="24" v-for="(property,index) in form.bizEntityJson.otherProperties" :key="index">
      ...
      <el-col :span="4">
        <div class="d-min" :class="{novalue: !property.totalDays, 'required': !form.bizEntityJson.disabled}">
          <el-input v-model="property.totalDays" @blur="formatVal(property)"></el-input>
        </div>
      </el-col>
