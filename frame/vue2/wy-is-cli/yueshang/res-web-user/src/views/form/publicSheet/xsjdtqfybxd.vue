  ...
  <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
    <el-row :gutter="24" class="top-row">
       <el-col :span="24" class="right-col">
        <div class="d-min">
          <span></span>
          <div class="d-red right-col" :class="{novalue: !form.bizEntityJson.hotel3 && !form.bizEntityJson.hotel4,required: !form.bizEntityJson.disabled}">
            <d-radio-group 
              v-model="form.bizEntityJson" 
              :nameList="[{label:'自营酒店',name:'hotel3'},
