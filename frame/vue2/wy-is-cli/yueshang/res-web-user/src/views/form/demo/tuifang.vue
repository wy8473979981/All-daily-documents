...
<template>
    ...
    <div :class="['public-box',{'disabled': form.bizEntityJson.disabled}]">
        ...
        <el-row class="padding-row">
            ...
            <el-col :span="24" class="right-col">
                <div class="d-min">
                    <span class="span-auto">申明</span>
                    <div class="d-min">
                    <div class="explain-p">
                        <p>本人申请上述房产的退购，并愿意支付以下费用：</p>
                        <p>原房屋成交总价违约金/手续费
                            <el-input :class="{'novalue': !form.bizEntityJson.dealTotalPenalty, 'required': !form.bizEntityJson.disabled}" v-model="form.bizEntityJson.dealTotalPenalty" style="width: 90px;border: 1px solid #ddd;"></el-input>
                            元。</p>
                        <p>业主签名：<el-input :class="{'novalue': !form.bizEntityJson.owerSignName, 'required': !form.bizEntityJson.disabled}" v-model="form.bizEntityJson.owerSignName" style="width: 200px;margin: 5px; border: 1px solid #ddd;"></el-input></p>
                    </div>
                    </div>
                </div>
            </el-col>
            <el-col :span="24" class="right-col">
                <div class="d-min">
                    ...
                    <el-input :class="{'novalue': !form.bizEntityJson.contentDesc}" v-model="form.bizEntityJson.contentDesc" type="textarea" autosize :placeholder="form.bizEntityJson.disabled ? '' : '请输入'"></el-input>
                </div>
            </el-col>
        </el-row>
