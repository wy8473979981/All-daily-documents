...
export default {
    ...
    params.map((item, index) => {
      ...
      documents.map((docItem, docIndex) => {
        ...
        docItem.imgList.map((imgItem, imgIndex) => {
          let obj = { index: imgIndex, contractDetailItemImgUrl: imgItem, dragList: [] };
  ...
  methods: {
    ...
    deleteGzcFunc (index) {
      this.contractDetailAry[this.currentContractDetailPage]['dragList'].splice(index, 1);
    ...
    onDragstop (newRect) {
      ...
      let currentItem = this.contractDetailAry[this.currentContractDetailPage]['dragList'][this.currentDragModuleIndex];// 当前拖拽的DOM节点

      let newDragItem = { ...currentItem, qyf: this.qianyuefangIndex, x: newRect.left, y: newRect.top };// 当前节点的新坐标

      this.contractDetailAry[this.currentContractDetailPage]['dragList'].splice(this.currentDragModuleIndex, 1, newDragItem);// 替换当前节点
    ...
    createDragFunc (DragType) {
      ...
      this.contractDetailAry[this.currentContractDetailPage]['dragList'].push(obj);
    },
    qfzFunc () {
