<template>
	<div class="home" v-webTitle :data-title="`待开业项目招商进度 - 品牌数`">
		...
		<ys-n-section :title="chartsTitle" :collapseable="collapseable">
			...
			<ys-n-table identity="tab1" :fixednum="1" :columns="businessColumns" :values="businessRows"
				:total-row="businessTotalRow" class="table-wrapper"></ys-n-table>
		</ys-n-section>
		<div class="ys-n-section ">
			<ys-n-echart :options="contractBrand" canvasId="htId" height="290px"></ys-n-echart>
			<ys-n-table identity="tab2" :fixednum="1" :columns="contractColumns" :values="contractRows"
				:total-row="contractTotalRow" class="table-wrapper"></ys-n-table>
		</div>
