    ...
    <div class="header-top">
      ...
      <div class="app-header">
        <div class="app-header-right">
          <ys-n-date-pick type="year-month" @selected="dateSelected" :selected="queryParams.yearMonth"></ys-n-date-pick>
    ...
    <div class="wrapper">
      <ys-n-section :title="chartsTitle" :collapseable="collapseable" v-if="show">
        <div class="head-actions_left_view" slot="head-actions_left">
          ...
          <!-- <image class="head-actions_left" src="@/assets/images/icon-arrow-down.png" catchtap="onActionsLeftCatch"/> -->
          <ys-n-filter-chart-dialog :searchList="searchTypeList" @search="searchType"></ys-n-filter-chart-dialog>
        </div>
  ...
  methods: {
    ...
    searchType(item) {
      ...
      if (item.wylx.value === "px") {
        (curChartData = this.pxCharData), (prevCartData = this.pxPrevYearCharData), (decimals = "xiaoshoupaiming"), (unit =
          "元/㎡");
      }
