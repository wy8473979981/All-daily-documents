<template>
	<div class="ys-page">
		...
		<index-content v-for="data in list" :data="data" :users="data.users" @userTab="userTab" url="/pages/sign/ranking/index"></index-content>
		<!-- 下拉框组件数据 -->
			...
			createHtml(data,state) {
				...
				Object.keys(data).forEach(key => {
					...
					signAndPaymentItem = [
						...
						{col1: item.signAmount,col2: '',col3: '',col1_unit:'亿元'},
						
						{col1: "本月",col1class:'custom-title-cls',col2: '',col3: ''},
						{col1: '本月指标',col2: '本月实际',col3: '本月完成率'},
						{col1: item.monthSignIndexAmount,col2: item.monthSignAmount,col3: item.monthSignRate
						,col1_unit : '亿元',col2_unit : '亿元',col3_unit : '%'},
						
						{col1: '本年',col1class:'custom-title-cls',col2: '',col3: ''},
						{col1: '本年指标',col2: '本年实际',col3: '本年完成率'},
						{col1: item.yearSignIndexAmount,col2: item.yearSignAmount,col3: item.yearSignRate
						,col1_unit : '亿元',col2_unit : '亿元',col3_unit : '%'},
						
						{col1: '截至上月',col1class:'custom-title-cls',col2: '',col3: ''},
						{col1: '截至上月指标',col2: '截至上月实际',col3: '偏差率/缺口'},
						{col1: item.lastMonthSignIndexAmount,col2: item.lastMonthSignAmount,col3:'' 
						,col1_unit : '亿元',col2_unit : '亿元'},
					];
					//红绿灯判断
					signAndPaymentItem[11].col3 = "<span style='font-size:15px;'>" + item.lastMonthSignRate + '%</span>'
					 + "<span style='font-size:12px;'>"+ (item.lastMonthSignAmount - item.lastMonthSignIndexAmount).toFixed(2) + '亿元</span>';
					signAndPaymentItem[11].col3color = item.lastMonthSignRate>=0?{color:'green'}:{color:'red'};
