	...
	data() {
		return {
			...
			projectColumns: [
				...
				{label: "昨日签约面积",key: "signAmount",width: "280rpx",sortable: false,align: "right",},
				{label: "昨日签约金额",key: "signArea",width: "280rpx",sortable: false,align: "right",},
				{label: "本月签约面积",key: "monthSignArea",width: "280rpx",sortable: false,align: "right",},
				{label: "本月签约金额",key: "monthSignAmount",width: "280rpx",sortable: false,align: "right",},
				{label: "本月签约指标",key: "monthSignIndexAmount",width: "280rpx",sortable: false,align: "right",},
				{label: "本年签约面积",key: "yearSignArea",width: "280rpx",sortable: false,align: "right",},
				{label: "本年签约金额",key: "yearSignAmount",width: "280rpx",sortable: false,align: "right",},
				{label: "本年签约指标",key: "yearSignIndexAmount",width: "280rpx",sortable: false,align: "right",},
				{label: "截止上月累计签约",key: "lastMonthSignAmount",width: "320rpx",sortable: false,align: "right",},
				{label: "截止上月累计指标",key: "lastMonthSignIndexAmount",width: "320rpx",sortable: false,align: "right",},
	...
	onLoad: function (options) {
		...
		if(options.params === undefined){
			...
			this.projectColumns = [
				...
				{label: "本年签约指标",key: "yearSignIndexAmount",width: "280rpx",sortable: false,align: "right",},
				{label: "截止上月累计签约",key: "lastMonthSignAmount",width: "320rpx",sortable: false,align: "right",},
				{label: "截止上月累计指标",key: "lastMonthSignIndexAmount",width: "200rpx",sortable: false,align: "right",},
				{label: "更新人",key: "modifyUserName",width: "280rpx",sortable: false,align: "left",},
				{label: "更新日期",key: "modifyDate",width: "380rpx",sortable: false,align: "left",}
			];
			this.initData();
