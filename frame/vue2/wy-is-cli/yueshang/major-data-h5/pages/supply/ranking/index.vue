  ...
  <div class="ys-page">
    ...
    <view v-if="isFullCal">
      <app-table
        ...
        :changeNum="changeNum"
        :values="list"
        :columns="isFullProjectColumns"
        :selected="tableSelected"
        @row-column-click="onRowColumnClick"
      ></app-table>
    </view>
    <view v-else>
      <app-table
        ...
        :changeNum="changeNum"
        :values="list"
        :columns="isNotFullProjectColumns"
        :selected="tableSelected"
        @row-column-click="onRowColumnClick"
      ></app-table>
    </view>
...
export default {
  ...
  onLoad: function (options) {
    ...
    this.supplyQueryParam.divisionOrGroupMarketing = params.divisionOrGroupMarketing
    if (params.divisionOrGroupMarketing === '0') {
      this.title = params.divisionName
      this.supplyQueryParam.divisionCode = params.divisionCode
    } else {
      this.title = params.groupMarketingName
      this.supplyQueryParam.groupMarketing = params.groupMarketing
    }
