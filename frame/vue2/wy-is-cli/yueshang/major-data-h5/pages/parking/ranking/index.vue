...
export default {
	data() {
		return {
			...
			projectColumns: [
				...
				{label: "年结转可售个数",key: "carryOverValue",width: "280rpx",sortable: false,align: "right",},
				{label: "年新增个数",key: "newValue",width: "280rpx",sortable: false,align: "right",},
				{label: "总可售个数",key: "totalSaleable",width: "280rpx",sortable: false,align: "right",},
	...
	onLoad: function (options) {
		...
		if(this.reqParam.groupType === 'divisionGroup'){
			this.reqParam.divisionCode = params.divisionCode;
		}else{
			this.reqParam.groupMarketingCode = params.groupMarketingCode;
		}
