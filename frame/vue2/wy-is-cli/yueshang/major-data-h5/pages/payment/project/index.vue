		...
		data() {
			return {
				...
				projectColumns: [{label: "序号",width: "90rpx",},
					...
					{label: "昨日回款金额",key: "paymentAmount",width: "200rpx",sortable: false,align: "right",},
					{label: "本月回款金额",key: "monthPaymentAmount",width: "200rpx",sortable: false,align: "right",},
					{label: "本年回款金额",key: "yearPaymentAmount",width: "200rpx",sortable: false,align: "right",},
			...
			createHtml(data,state){
				Object.keys(data).forEach(key => {
					...
					item.forEach(rowData=>{
						...
						newRow.paymentAmount = rowData.paymentAmount;
						newRow.monthPaymentAmount = rowData.monthPaymentAmount.toFixed(2);
						// newRow.monthPaymentIndexAmount = rowData.monthPaymentIndexAmount.toFixed(2);
						newRow.yearPaymentAmount = rowData.yearPaymentAmount.toFixed(2);
						// newRow.yearPaymentIndexAmount = rowData.yearPaymentIndexAmount.toFixed(2);
