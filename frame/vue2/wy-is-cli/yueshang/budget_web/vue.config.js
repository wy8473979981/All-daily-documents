...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      '/': {
        // 目标接口域名
        target: 'http://pmstest.powerlong.com/budget/', // 宝龙pms预算测试
        // target: 'http://192.168.120.169:10008/budget/', // 许进
        // target: 'http://192.168.120.157:10008/budget/', // 黄春
        // target: 'http://192.168.120.130:10008/budget/', // 糖糖
