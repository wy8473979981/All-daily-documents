      ...
      <el-row :gutter="20" style="display:block;width:100%">
        <el-col class="select-title" :span="18">
          <div class="select-cutover">
            <span @click="$router.push({path: '/management/read/shouru/index',query:routerQuery})">总收入</span>
...
import { mockData2 } from './mockData/mockData.js'
  ...
  methods: {
    ...
    async getList() {
      ...
      setTimeout(() => {
        ...
        this.pageInfo.total = mockData2.length;
