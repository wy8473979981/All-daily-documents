<template>
  ...
  <div class="list-page">
    <el-row class="tool-bar" type="flex" justify="space-between" align="middle" style="flex-flow: wrap;">
      <el-col class="select-title" :span="20">
        <div class="select-cutover">
          <span class="select-blue">安全保卫费明细</span>
          <span @click="$router.push({path: '/management/budgetView/disburse/securityBudget',query:toRouter})">安全保卫费</span>
        </div>
      </el-col>
      <el-col :span="16">
    ...
    <el-table class="table-input-box" ref="table" :data="tableData" size="mini" border stripe header-row-class-name="table-header" :height="this.$store.state.tableHeight" :cell-style="{ padding: '4px 0' }">
      ...
      <el-table-column min-width="150" label="计费依据-配置人数" show-overflow-tooltip prop="peopleNum" align="right">
        <template slot-scope="scope">
          <p @click="showInput(scope.$index)">{{ returnValue(scope.row,'peopleNum',true,false,'subject',0) }}</p>
        </template>
      </el-table-column>
      <el-table-column min-width="170" label="计费依据-次数、数量" :show-overflow-tooltip="!isEdit" prop="number" align="right">
        <template slot-scope="scope">
          ...
          <p v-else @click="showInput(scope.$index)">{{ returnValue(scope.row,'number',true,false,'subject') }}</p>
        </template>
      </el-table-column>
      ...
      <el-table-column min-width="140" label="履约起始期" :show-overflow-tooltip="!isEdit" prop="start" align="right">
        <template slot-scope="scope">
          ...
          <p v-else @click="showInput(scope.$index)">{{ returnValue(scope.row,'start',false,true,'subject') }}</p>
        </template>
      </el-table-column>
      <el-table-column min-width="140" label="履约终止期" :show-overflow-tooltip="!isEdit" prop="end" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="150" label="合约(权责)期限(月)" :show-overflow-tooltip="!isEdit" prop="term" align="right">
        <template slot-scope="scope">
          ...
          <p v-else @click="showInput(scope.$index)">{{ returnValue(scope.row,'term',true,false,'subject',0) }}</p>
        </template>
      </el-table-column>
      <el-table-column min-width="150" label="计入本年期限(月)" :show-overflow-tooltip="!isEdit" prop="yearTerm" align="right">
        <template slot-scope="scope">
          ...
          <p v-else @click="showInput(scope.$index)">{{ returnValue(scope.row,'yearTerm',true,false,'subject',0) }}</p>
        </template>
      </el-table-column>
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/01`" :show-overflow-tooltip="!isEdit" prop="jan" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/02`" :show-overflow-tooltip="!isEdit" prop="feb" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/03`" :show-overflow-tooltip="!isEdit" prop="march" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/04`" :show-overflow-tooltip="!isEdit" prop="april" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/05`" :show-overflow-tooltip="!isEdit" prop="may" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/06`" :show-overflow-tooltip="!isEdit" prop="june" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/07`" :show-overflow-tooltip="!isEdit" prop="july" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/08`" :show-overflow-tooltip="!isEdit" prop="aug" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/09`" :show-overflow-tooltip="!isEdit" prop="sep" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/10`" :show-overflow-tooltip="!isEdit" prop="oct" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/11`" :show-overflow-tooltip="!isEdit" prop="nov" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="140" :label="`${getBudgetYear}/12`" :show-overflow-tooltip="!isEdit" prop="dece" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="200" label="备注说明" :show-overflow-tooltip="!isEdit" prop="remark">
        <template slot-scope="scope">
          ...
          <p v-else @click="showInput(scope.$index)">{{ returnValue(scope.row,'remark',false,true,'subject') }}</p>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    async getFormId() {
      try {
        // 查询
        const params = { detailId: this.routerQuery.budgetInstanceSheetId, feeType: 2 };
