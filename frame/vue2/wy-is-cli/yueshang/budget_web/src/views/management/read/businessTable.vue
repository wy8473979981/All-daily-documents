<template>
  ...
  <div class="list-page">
    <el-row class="tool-bar" type="flex" justify="space-between" align="middle" style="flex-flow: wrap;">
      <el-col class="">
        <el-select placeholder="业务表" size="mini" v-model="query.project_config_id" @change="getListChange" filterable clearable style="margin-right: 5px; width: 180px;">
          <el-option
        ...
        <el-select placeholder="状态" size="mini" v-model="query.project_config_id" @change="getListChange" filterable clearable style="margin-right: 5px; width: 180px;">
          <el-option
            v-for="item in projectList"
            :key="item.project_config_id"
            :label="item.project_name + '-' +item.project_label_name"
    ...
    <el-table ref="table" :data="tableData" size="mini" border stripe header-row-class-name="table-header" :height="this.$store.state.tableHeight">
      <el-table-column min-width="150" label="业务表" show-overflow-tooltip prop="project_name" />
      <el-table-column min-width="150" label="部门名称" show-overflow-tooltip prop="project_name" />
      <el-table-column min-width="150" label="状态" show-overflow-tooltip prop="project_name" />
      <el-table-column min-width="120" label="提交人" show-overflow-tooltip prop="project_name" />
      <el-table-column min-width="120" label="提交时间" show-overflow-tooltip prop="project_name" />
      ...
      <el-table-column fixed="right" width="80" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="mini" @click="goMember(scope.row.id)">详情</el-button>
