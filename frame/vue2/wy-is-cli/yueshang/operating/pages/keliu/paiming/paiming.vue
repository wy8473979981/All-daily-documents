	...
	<view>
		...
		<view class="wrapper" style="margin-top: 12rpx">
			...
			<app-section title="项目排名">
				...
				<app-table :values="table.dataList" :columns="table.columns" :totalRow="table.totalRow" :fixednum="2"
				 @row-column-click="onRowColumnClick"> </app-table>
			</app-section>
		</view>
		<app-filter-dialog :checkboxes="dataList" @selected="showComparisonList" v-if="params.type !== 'dj'" tip="注意：最少选两项"
		 @open="bindopen" @close="bindclose">
