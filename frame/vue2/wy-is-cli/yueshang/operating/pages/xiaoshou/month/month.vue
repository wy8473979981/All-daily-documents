...
export default {
  ...
  methods: {
    onRowClick(e) {
      ...
      // });
	  // const url = '/sjfx/index.html#/pages/sjgl/sjxx/sjxx'
	  let url = './sjfx/index.html#/pages/sjgl/sjxx/sjxx?bisShopId='+e.detail.row.bisProjectId
	  // if(window.WebViewJavascriptBridge) {
		 //  // url = 'http://pms.powerlong.com/plapp_static/sjfx/index.html#/pages/sjgl/sjxx/sjxx?bisShopId='+e.detail.row.bisProjectId
			// url = './sjfx/index.html#/pages/sjgl/sjxx/sjxx?bisShopId='+e.detail.row.bisProjectId
	  // }
	  window.location.href = url
	  // this.$util.pageGo(url,{bisShopId: e.detail.row.bisProjectId})
    },
