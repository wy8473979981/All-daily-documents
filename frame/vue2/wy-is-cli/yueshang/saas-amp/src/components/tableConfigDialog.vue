<template>
  ...
  >
    ...
    <el-form label-width="150px" :inline='true'>
      ...
      <div class="btn-group">
        <el-button @click="confirmCreate" size="mini" type="primary"
    ...
    <el-form label-width="150px" :inline='true'>
      ...
      <div class="btn-group">
        <el-button @click="confirmUpdate" size="mini" type="primary"
...
export default {
  ...
  methods: {
    ...
    confirmUpdate () {
      ...
      let colSelected = col[this.updateConfig.colIndex - 1]
      colSelected.setAttribute('width', this.updateConfig.colWidth + '')
      let colsWidth = [...col].map(item => {
