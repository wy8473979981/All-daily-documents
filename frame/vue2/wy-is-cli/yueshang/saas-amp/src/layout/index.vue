<template>
  <el-container>
    <el-aside :width="isCollapse ? '50px' : '160px'" class="hidden-sm-and-down" :class="{'smlogo':isCollapse}">
        <div class="logo-box">
    ...
    <el-container style="width: 90%;width: calc(100vw - 160px);">
      <el-header height="44px" style="justify-content: space-between;">
...
/deep/ .el-tabs__header,/deep/ .el-tabs__nav-wrap,/deep/ .el-tabs__nav-scroll,/deep/ .el-tabs__nav{
  height: 100%;
}
/deep/ .el-tabs--card > .el-tabs__header .el-tabs__nav,/deep/ .el-tabs__item{
