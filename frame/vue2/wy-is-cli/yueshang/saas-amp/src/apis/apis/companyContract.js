...
class CompanyCont extends Base {
  ...
  async create(p, showMsg) {
    ...
    const res = await post("/RentCalculation/add", p);
    this.codeMap = code;
    this.code = res.code;
  ...
  async find(p, showMsg) {
    ...
    const res = await post("/RentCalculation/list", p);
    this.codeMap = code;
    this.code = res.code;
    this.showMsg = showMsg;
    // this.message()
  ...
  async analogyList(p, showMsg) {
    ...
    const res = await post("/CompetingProductsAnalogy/list", p);
    this.codeMap = code;
    this.code = res.code;
    this.showMsg = showMsg;
    // this.message()
  ...
  async getList(p, showMsg) {
    ...
    const res = await post("/RentMarketResearch/getList", p);
    this.codeMap = code;
    this.code = res.code;
    this.showMsg = showMsg;
    // this.message()
  ...
  async getUpdate(p, showMsg) {
    ...
    const res = await post("/RentCalculation/update", p);
    this.codeMap = code;
    this.code = res.code;
    this.showMsg = showMsg;
    this.message();
  ...
  async del(p, showMsg) {
    ...
    const res = await post("/RentCalculation/delete", p);
    this.codeMap = code;
    this.code = res.code;
    this.showMsg = showMsg;
    this.message();
  ...
  async analogyDel(p, showMsg) {
    ...
    const res = await post("/CompetingProductsAnalogy/delete", p);
    this.codeMap = code;
    this.code = res.code;
    this.showMsg = showMsg;
    this.message();
  ...
  async getAnalogyType (p, showMsg) {
    ...
    const res = await post('/CompetingProductsAnalogy/competingProductsAnalogyType', p)
    this.codeMap = code
    this.code = res.code
    this.showMsg = showMsg
    // this.message()
  ...
  async getAnalogyList (p, showMsg) {
    ...
    const res = await post('/CompetingProductsAnalogy/competingProductsAnalogyList', p)
    this.codeMap = code
    this.code = res.code
    this.showMsg = showMsg
    // this.message()
  ...
  async saveAnalogyList (p, showMsg) {
    ...
    const res = await post('/CompetingProductsAnalogy/competingProductsAnalogySave', p)
    this.codeMap = code
    this.code = res.code
    this.showMsg = showMsg
    this.message()
  ...
  async getRentCalculationMainList (p, showMsg) {
    ...
    const res = await post('/CompetingProductsAnalogy/rentCalculationMainList', p)
    this.codeMap = code
    this.code = res.code
    this.showMsg = showMsg
    // this.message()
