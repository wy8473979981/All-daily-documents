        ...
        <el-form :model='loginForm' ref="loginRef">
          ...
          <div style="margin-right: 10px; width: 450px; display: flex; align-items: center;">
            <el-form-item style="margin-bottom: 0; margin-right: 15px;">
              <el-input class="code" v-model="loginForm.img_code" size='big' placeholder='请输入验证码' maxlength="4" style='width: 200px;' @keyup.enter.native='handleLogin' />
            </el-form-item>
            <img alt="" style="width: 85px; height: 40px;border: unset;" ref="kaptcha" @click="refreshKaptcha">
          </div>
        </el-form>
