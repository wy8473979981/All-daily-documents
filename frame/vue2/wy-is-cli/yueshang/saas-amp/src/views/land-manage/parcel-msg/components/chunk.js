...
export default {
  ...
  countPropertySaleFloorUnitprice(config, others) {
    ...
    if(config.land_per && config.property_sale_land_per && others.sale_property_ground_area) {
      config.property_sale_floor_unitprice = (config.land_per * 100000000 * config.property_sale_land_per / 100 / others.sale_property_ground_area).toFixed(2);
    }else{
  ...
  countPropertyHoldFloorUnitprice(config, others) {
    ...
    if(config.land_per && config.property_hold_land_per && others.hold_property_ground_area) {
      config.property_hold_floor_unitprice = (config.land_per * 100000000 * config.property_hold_land_per / 100 / others.hold_property_ground_area).toFixed(2);
    }else{
