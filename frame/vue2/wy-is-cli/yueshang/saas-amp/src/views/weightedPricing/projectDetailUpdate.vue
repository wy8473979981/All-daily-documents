  ...
  <div class="list-page">
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="距离项目(公里)">
        <template slot-scope="scope">
          <el-input v-show="true" :disabled="detailInput" size="mini" v-model="scope.row.distance" placeholder="请输入" />
        </template>
      </el-table-column>
      <el-table-column
        prop="position"
      ...
      <el-table-column
        ...
        label="开业年限">
        <template slot-scope="scope">
          <el-input v-show="true" :disabled="detailInput" size="mini" v-model="scope.row.open_year" placeholder="请输入" />
        </template>
      </el-table-column>
      <el-table-column
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button @click="detailUpdate(0)" type="warning" size="mini">编辑</el-button>
          <el-button @click="detailUpdate(1,scope.row)" type="primary" size="mini">保存</el-button>
          <el-button @click="detailUpdate(2)" type="danger" size="mini">取消</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!--[项目详情编辑表 end]-->
    ...
    <!--[非主力店品牌 start]-->
    <el-tag effect="dark" class="font-c-w" style="border-radius: 4px 4px 0 0;">非主力店</el-tag>
    <el-table
      :data="detailData2"
      ...
      <el-table-column
          ...
          <el-table-column
            ...
            label="物管费(元/m²/月)">
            <template slot-scope="scope">
              <el-input v-show="true" :disabled="scope.row.detailInput==='true'?true:scope.row.detailInput" size="mini" v-model="scope.row.management_fee" placeholder="请输入" />
            </template>
          </el-table-column>
          <el-table-column
            prop="period"
          ...
          <el-table-column
            ...
            <template slot-scope="scope" v-if="scope.row.floor !== '快速创建'">
              ...
              <el-button @click="detailAdd(1,scope.row)" type="primary" size="mini">保存</el-button>
              <el-button @click="detailAdd(2,scope.row,scope.$index,detailData2)" type="danger" size="mini">删除</el-button>
            </template>
          </el-table-column>
        </el-table-column>
    </el-table>
    ...
    <!--[主力店品牌 start]-->
    <el-tag effect="dark" class="font-c-w" style="border-radius: 4px 4px 0 0;">主力店</el-tag>
    <el-table
      :data="detailData3"
      :row-style="tableRowStyle"
      :header-cell-style="tableHeaderColor"
      ...
      <el-table-column
          ...
          <el-table-column
            ...
            <template slot-scope="scope" v-if="scope.row.floor !== '快速创建'">
              <el-button @click="detailAdd(0,scope.row)" type="warning" size="mini">编辑</el-button>
              <el-button @click="detailAdd(1,scope.row)" type="primary" size="mini">保存</el-button>
              <el-button @click="detailAdd(2,scope.row,scope.$index,detailData3)" type="danger" size="mini">删除</el-button>
            </template>
          </el-table-column>
        </el-table-column>
    </el-table>
      ...
      handler(newV, oldV){
        newV.forEach(item => {
          if (item.inner_area && item.rent_univalent){
            item.rent_month_amount = item.inner_area * item.rent_univalent
          }
        })
      },
      deep: true
