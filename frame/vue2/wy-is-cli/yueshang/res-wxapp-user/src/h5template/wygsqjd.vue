...
<template>
	<div class="template-wrapper">
      ...
      <p>
				<span class="span-title">选择	:</span>
        <span class="span-value" v-if="form.bizEntityJson.cityBoss">城市公司第一负责人</span>
        <span class="span-value" v-if="form.bizEntityJson.cityLeader">城市公司部门负责人</span>
        <span class="span-value" v-if="form.bizEntityJson.cityOther">城市公司其他人员</span>
        <span class="span-value" v-if="form.bizEntityJson.propertyLeader">物业项目第一负责人</span>
        <span class="span-value" v-if="form.bizEntityJson.propertyOther">物业项目其他人员</span>
			</p>
      <p>
