...
<template>
	<div class="template-wrapper">
      ...
      <p>
        ...
        <span class="span-value" v-if="form.bizEntityJson.company1">事业一部</span>
        <span class="span-value" v-if="form.bizEntityJson.company2">事业二部</span>
        <span class="span-value" v-if="form.bizEntityJson.company3">置地</span>
        <span class="span-value" v-if="form.bizEntityJson.company4">浙江事业部</span>
        <span class="span-value" v-if="form.bizEntityJson.company7">安徽事业部</span>
        <span class="span-value" v-if="form.bizEntityJson.company6">广东事业部</span>
			</p>
      <p>
      ...
      <p>
				<span class="span-title">选择	:</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel1">地产公司负责人</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel4">部门负责人（双线）</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel3">部门负责人（非双线）</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel2">其他人员</span>
			</p>
      <p>
