...
<template>
	<div class="template-wrapper">
      ...
      <p>
				<span class="span-title">选择	:</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel1">执行董事</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel2">集团总经理</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel3">总经理级</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel4">部门负责人(非总经理级)</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel5">其他人员</span>
			</p>
      <p>
