...
<template>
	<div class="template-wrapper">
      ...
      <p>
				<span class="span-title">项目类型	:</span>
        <span class="span-value" v-if="form.bizEntityJson.isProjectType == 1">B类项目</span>
        <span class="span-value" v-if="form.bizEntityJson.isProjectType == 2">非B类项目</span>
			</p>
      <p>
      ...
      <p>
				<span class="span-title">选择	:</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel1">总经理</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel3">其他人员</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel7">副总经理/部门负责人（双线）</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel8">副总经理/部门负责人（非双线）</span>
			</p>
      <p>
