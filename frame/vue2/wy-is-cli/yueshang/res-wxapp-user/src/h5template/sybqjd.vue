...
<template>
	<div class="template-wrapper">
      ...
      <p>
				<span class="span-title">选择	:</span>
        <span class="span-value" v-if="form.bizEntityJson.newPositionLevel1 == 'true'">事业部负责人</span>
        <span class="span-value" v-if="form.bizEntityJson.newPositionLevel2 == 'true'">其他M序列</span>
        <span class="span-value" v-if="form.bizEntityJson.newPositionLevel3 == 'true'">其他P序列</span>
			</p>
      <p>
