...
<template>
	<div class="template-wrapper">
      ...
      <p>
				<span class="span-title">选择	:</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel1">商业集团</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel2">区域公司</span>
			</p>
      <p>
				<span class="span-title">选择	:</span>
        <!-- 商业集团 -->
        <span class="span-value" v-if="form.bizEntityJson.positionLevel3">集团总裁</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel11">副总裁</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel4">助理总裁/中心负责人</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel5">部门负责人</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel7">其他人员</span>
        <!-- 区域公司 -->
        <span class="span-value" v-if="form.bizEntityJson.positionLevel8">总经理</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel12">部门负责人(双线)</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel13">部门负责人(非双线)</span>
        <span class="span-value" v-if="form.bizEntityJson.positionLevel10">其他人员</span>
			</p>
      <p>
      ...
      <p v-if="form.allEntityFileIds.fileId.length > 0">
				<span class="span-title">相关材料:</span>
