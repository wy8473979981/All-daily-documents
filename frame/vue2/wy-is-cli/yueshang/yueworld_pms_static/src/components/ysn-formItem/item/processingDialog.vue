  ...
  >
    ...
    <template slot="content">
      <YsnPageContent
        ...
        persmission="ItemProcessingDialog"
  ...
  data() {
    return {
      ...
      searchConfig: [{ itemType: 'input', prop: 'fuzzyEnquiry', label: '', placeholder: '请输入商家/企业名称/编号', width: '220px', isSearch: true, isFirst: true },
        { itemType: 'selectDialog', prop: 'programName', width: '200px', isFirst: true, placeholder: '所有项目', list: PUBFN.getOptionsList('PayableList') },
