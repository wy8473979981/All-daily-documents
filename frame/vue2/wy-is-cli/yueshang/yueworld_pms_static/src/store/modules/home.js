...
const mutations = {
  SET_ROSE_OPTION: (state, data) => {
    state.roseOption.series[0].data = data.outerData1
    state.roseOption.series[1].data = data.outerData2
    state.roseOption.series[2].data = data.innerData
    state.roseOption.series[3].data = data.innerData
    state.projectList = data.outerData1
    state.projectList1 = data.outerData1
    state.innerData = data.innerData
    state.outerData1 = data.outerData1
    state.outerData2 = data.outerData2
  },
