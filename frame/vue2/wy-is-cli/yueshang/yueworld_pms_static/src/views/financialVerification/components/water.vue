<template>
  <div class="bond">
    <div class="table">
      <div class="tablelist">
        <el-table :data="tableDatas" style="width: 100%; font-size: 10px" @sort-change="sort_change">
          <el-table-column label="序号" type="index" :index="indexMethod" width="80" align="center" />
          <el-table-column prop="name" label="合同编号" sortable>
          ...
          <el-table-column prop="name2" label="品牌" sortable>
            <template slot="header">
              <span>品牌</span>
              <img
          ...
          <el-table-column prop="name3" label="租户" sortable>
            <template slot="header">
              <span>租户</span>
              <img
              ...
              <img
                ...
                alt=""
              ></template></el-table-column>
          <el-table-column prop="name4" label="铺位" width="200" sortable>
            <template slot="header">
              <span>铺位</span>
              <img
              ...
              <img
                ...
                alt=""
              ></template></el-table-column>
          <el-table-column prop="name5" label="费项" sortable>
            <template slot="header">
              <span>费项</span>
              <img
              ...
              <img
                ...
                alt=""
              ></template></el-table-column>
          <el-table-column prop="name6" label="结算金额" sortable>
            <template slot="header">
              <span>结算金额</span>
              <img
              ...
              <img
                ...
                alt=""
              ></template></el-table-column>
          <el-table-column prop="name7" label="原因" sortable>
            <template slot="header">
              <span>原因</span>
              <img
              ...
              <img
                ...
                alt=""
              ></template></el-table-column>
          <el-table-column prop="name8" label="核销日期" sortable>
            <template slot="header">
              <span>核销日期</span>
              <img
      ...
      <div class="paging">
        ...
        <div class="paging-option">
          ...
          <el-select v-model="value">
            <el-option label="每页10条" value="1" />
            <el-option label="每页20条" value="2" />
          </el-select>
        </div>
      </div>
    </div>
