  ...
  data() {
    return {
      tableConfig: [ // 表格配置
        ...
        { rentCalculation: '预算单价(元/m²/月)', width: '180px', type: 'money' },
        { architecture: '申请单价(元/m²/月)', width: '180px', type: 'money' },
        { sleeve: '预算年收入(万)', width: '130px', type: 'money' },
        { other: '申请后年收入(万)', width: '150px', type: 'money' },
        { annualIncomeDiff: '年收入差异额(万)', width: '150px', type: 'money' },
