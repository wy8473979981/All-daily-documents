...
export default {
  ...
  data() {
    return {
      // 配置
      tableConfig: [
        { tenantLetterhead: '开票名称', hasSlot: true },
        { tenantLetterheadUnifiedSocialCreditCode: '统一社会信用代码', hasSlot: true },
        { tenantLetterheadAddress: '地址', hasSlot: true },
        { tenantLetterheadTel: '电话', hasSlot: true },
        { tenantLetterheadBankname: '开户行', hasSlot: true },
        { tenantLetterheadBankaccount: '开户账号', hasSlot: true }
      ]
    }
  },
  methods: {}
