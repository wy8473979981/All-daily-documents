 ...
 * @LastEditTime: 2021-07-13 16:29:09
-->
<template>
  <div>
    <ysn-displayInfo
...
export default {
  ...
  computed: {
    ...
    configData() {
      ...
      console.log(list)
      return [
        { itemType: 'select', prop: 'leaseArea', label: '租赁区域', placeholder: '请输入', width: '206px', list: this.$PUBFN.getOptionsList('globalSearchList'), listName: 'label', listValue: 'value', multiple: true, change: this.changeLeaseArea, hasSlot: true },
