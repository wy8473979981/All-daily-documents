...
var tableList = [
  ...
  { leasTterm: '租赁期间', align: 'center', tableList: [
    { t4: '日期', wdith: '300px' }, // TODP 两个字段 数据处理 beginningDate 租期开始日  endingDate 租期结束日
    { isPromotional: '优惠' }
  ] },
  { tax: '税率' },
  { name: '申请条件', align: 'center', labelClass: 'borderBottom', tableList: [
  ] }
]
// 下面表格
var listTable = [
  ...
  { tax: '税率' },
  { conditions: '申请条件', align: 'center', labelClass: 'borderBottom', tableList: [
  ] }
]
