...
export default {
  ...
  data() {
    return {
      // 配置
      tableConfig: [
        { tenantName: '公司名称', hasSlot: true },
        { programName: '所属项目', hasSlot: true },
        { tenantContactsPerson: '法人', hasSlot: true },
        { legalPersonPosition: '法人职务', hasSlot: true },
        { tenantContactsTel: '电话', hasSlot: true }
      ]
    }
  },
  methods: {}
