    ...
    >
      ...
      >
        <template #header>
          <div class="solt-icon">
            <span>{{ th.label }}</span>
            <span v-if="th.isSort" class="icon-box">
              <img
              ...
              <img
                ...
                width="20"
              >
              <img v-else src="@/assets/imges/16pt／排序@2x.png" width="20">
            </span>
          </div>
        </template>
        <template slot-scope="scope">
          <span :style="th.color || ''">{{ scope.row[th.prop] }}</span>
        </template>
      </el-table-column>
    </el-table>
  </div>
