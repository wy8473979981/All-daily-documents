 ...
 * @Description:
 * @Author: zengcheng
 * @Date: 2021-06-25 11:07:50
 * @LastEditors: zengcheng
 * @LastEditTime: 2021-06-25 14:48:32
-->
<template>
  <div>
    <ysn-dialog
    ...
    >
      <template #contain>
        <div>
          <el-form ref="rule" :model="editFormData" label-position="top" size="small" :rules="rules">
            <ysn-formItem
              :form="editFormData"
              :config="configData"
              :column="2"
      ...
      <template #btn>
        <div class="flex-ju-end mt-40">
          <ysn-btn class="mr-16" @click="validate">保存</ysn-btn>
...
export default {
  ...
  data() {
    return {
      ...
      formData: {},
      configData: [
        { itemType: 'input', placeholder: '请输入', prop: 'cityId', label: '城市编码' },
