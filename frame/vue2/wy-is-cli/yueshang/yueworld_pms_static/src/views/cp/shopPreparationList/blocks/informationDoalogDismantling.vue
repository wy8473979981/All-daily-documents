<template>
  <div>
    <ysn-dialog title="拆铺" :is-cancel="false" external :is-show-dialog="visible" :is-determine="false">
      ...
      <template #contain>
        ...
        <div v-for="(item,i) in num" :key="i">
          ...
          <el-form ref="ruleForm" :model="formData" label-position="top" size="small">
            <ysn-formItem label-position="top" :form="formData" :config="configData" :column="2" clearable />
          </el-form>
          <!-- 新签合同 -->
          ...
          <div class="flex-ju-al-between ">
            <div class="d-flex">
              ...
              <div class="color-0c66ff" @click="deletes">删除</div>
            </div>
