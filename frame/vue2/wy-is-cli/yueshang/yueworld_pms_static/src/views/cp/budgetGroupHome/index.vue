  ...
  <div class="group-container budget-page">
    <el-row :gutter="56">
      ...
      <el-col :span="12">
        ...
        <div id="trendsCon" style="width: 100%; height: 240px" />
      </el-col>
      <!-- 执行中预算 -->
      <el-col :span="12">
        ...
        <el-row class="executingBox">
          <el-col :span="6">
            <div id="progress" style="width: 110px; height: 110px" />

          </el-col>
          <el-col :span="10" class="tipsBox">
            <el-row><i />租金收入(万元)</el-row>
            <el-row>28,784.01</el-row>
            <el-row><i />租金包(万元)：<em>8,783.87 </em>
    ...
    <el-row>
      ...
      <el-row class="yearBox">
        <el-select ref="optionItem" v-model="optionYear" placeholder="请选择" class="yearCon" size="small" @change="yearChange">
          <el-option v-for="item in yearItem" :key="item.value" :label="item.label" :value="item.value" />
        </el-select>
      </el-row>
      <div class="d-flex mt-8 pl-16">
        <div class="budge-circle flex-al-center d-flex-column">
          <div id="progressCon" class="circle" />
          <div class="text-center mt-4">编制总进度</div>
        </div>
        <div class="budge-circle flex-al-center d-flex-column">
          <div id="completionRatio" class="circle" />
          <div class="text-center mt-4">完成项目占比</div>
        </div>
        <div class="budge-circle flex-al-center d-flex-column">
          <div id="expenditure" class="circle" />
    ...
    <el-row>
      ...
      <div class="paging pb-40">
        ...
        <div class="paging-option">
          <el-pagination layout="prev, pager, next,sizes" :page-sizes="[20, 40, 60, 80]" :total="8" />
        </div>
      </div>
    </el-row>
  </div>
