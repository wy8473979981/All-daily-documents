...
export default {
  ...
  data() {
    return {
      ...
      rulesForm: { // 表单验证
        taxTypeId: [{ message: '请输入必填项', trigger: 'change' }],
        centralizedId: [{ message: '请输入必填项', trigger: 'change' }],
        attributeId: [{ message: '请输入必填项', trigger: 'change' }],
        signedId: [{ message: '请输入必填项', trigger: 'change' }],
        areaType: [{ message: '请输入必填项', trigger: 'change' }]
      }
    }
  }
