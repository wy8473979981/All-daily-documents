...
<template>
  <div>
    <ysn-dialog :out-close="outClose" :title="'选择辅助核算生成规则'" :width="'920px'" :is-show-dialog="isShowDialog" :external="isShowDialog" @closeDialog="closeDialog">
      <!-- 弹窗表格 -->
      <template #contain>
        <el-form
          ref="ruleForm"
...
export default {
  ...
  methods: {
    ...
    saveBox() {
      ...
      const listArr = this.$PUBFN.getOptionsList('assistingRuleist')
      const that = this
