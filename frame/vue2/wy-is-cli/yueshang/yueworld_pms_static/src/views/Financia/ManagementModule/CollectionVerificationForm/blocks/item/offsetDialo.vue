...
export default {
  ...
  data() {
    return {
      ...
      outClose: true,
      searchConfigNo: [{ itemType: 'input', prop: 'fuzzyEnquiry', label: '', placeholder: '请输入应收编号/合同编号', width: '220px', isSearch: true, isFirst: true },
      ...
      tableConfig: [
        ...
        { actualReceivableAmount: '实际应收金额(元)', isShow: true },
        { unverifiedAmount: '未核销金额(元)', isShow: true },
