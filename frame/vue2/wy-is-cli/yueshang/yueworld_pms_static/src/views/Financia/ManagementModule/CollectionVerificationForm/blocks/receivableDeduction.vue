...
export default {
  ...
  data() {
    return {
      ...
      flag: false,
      formTableConfig: [
        { contNo: '合同编号', sortable: 'true', itemType: 'text', width: '110px' },
        { receivableNo: '应收编号', sortable: 'true', itemType: 'text', width: '120px' },
        ...
        { reductionAmount: '冲减金额(元)', sortable: 'true', itemType: 'input', inputType: 'Number', width: '120px', type: 'number' }
      ]
    }
  },
  computed: {
