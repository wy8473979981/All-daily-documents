...
<template>
  <div class="app-page-main">
    <YsnPageContent
      ...
      persmission="CashflowModuleList"
...
<script>
// 请求api
import { searchConfig, tableConfig, statusSearchConfig, queryConfig, tableOrderConfig, searchForm } from './config'
...
export default {
  ...
  methods: {
    ...
    async successTableList() {
      await this.$refs.CashflowModuleList.getList()
      await this.update++
    },
    /**
     * @description: 删除
