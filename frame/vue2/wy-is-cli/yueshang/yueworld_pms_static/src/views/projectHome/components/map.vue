      ...
      <div class="flex-ju-between flex-al-end">
        ...
        <div>
          <el-input
            ...
            class="w126 mr-16"
          />
          <el-select v-model="value" placeholder="责任人" size="small" class="w126 mr-32">
            <el-option
...
export default {
  ...
  data() {
    return {
      ...
      pointList: [
        { name: '进场', state: 2, time: '2020-04-20 12:16' },
        { name: '洽谈', state: 3, time: '2020-04-10 12:16' },
        { name: '进场', state: 3, time: '2020-04-08 12:16' },
        { name: '合同', state: 3, time: '2020-04-04 12:16' },
        { name: '双签', state: 3, time: '2020-04-10 12:16' }
      ]
    }
  },
  methods: {
