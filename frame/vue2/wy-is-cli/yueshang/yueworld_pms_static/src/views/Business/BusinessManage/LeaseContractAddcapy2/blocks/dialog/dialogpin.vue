 ...
 * @LastEditTime: 2021-08-05 19:30:40
-->
<template>
  <div>
    <ysn-formTable
  ...
  computed: {
    add() {
      if (this.typeStatus.isRentShop === '1') {
        return ['t12', 'name', 'monthlyEstimatedTurnover', 'commDiscountApply', 'leaseArea', 'beginningDate', 'endingDate', 'salesTaxRate']
      }
      return ['t12', 'name', 'monthlyEstimatedTurnover', 'commDiscountApply', 'beginningDate', 'endingDate', 'salesTaxRate']
    },
    formTableConfig() {
