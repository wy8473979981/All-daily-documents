 ...
 * @LastEditTime: 2021-07-26 01:06:44
-->
<template>
  <div>
    <ysn-formTable
    ...
    >
      ...
      <template #startingMonthlyTurnover="scope">
        <el-input v-model="scope.row.startingMonthlyTurnover" placeholder="请输入内容" />
      </template>

      <template #endingMonthlyTurnover="scope">
        <el-input v-model="scope.row.endingMonthlyTurnover" placeholder="请输入内容" />
      </template>
    ...
    <div class="flex-ju-end mt-20">
      ...
      <ysn-btn v-if="status==='1'" type="info" @click="isstatus">保2存并返回</ysn-btn>
    </div>
  </div>
</template>
<script>
