    ...
    return {
      ...
      formData: {
        ...
        feeInformationData: {
          tableData: [], // 表格数据
          tableConfig: [ // 表单配置
            { feeName: '费用类型', width: 250, itemType: 'text' },
            { actualReceivableAmount: '实际应收金额(元)', type: 'money', width: 250, itemType: 'text' },
            { receivedAmount: '已核销金额(元)', type: 'money', width: 250, itemType: 'text' },
            { unverifiedAmount: '未核销金额(元)', type: 'money', width: 250, itemType: 'text' }
          ]
        },
        // 进场装修相关资料
        attachmentList: {
