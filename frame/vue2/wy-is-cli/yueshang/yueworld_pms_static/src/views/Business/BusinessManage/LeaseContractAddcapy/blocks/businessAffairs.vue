 ...
 * @LastEditTime: 2021-07-26 01:46:39
-->
<template>
  <div>
...
export default {
  ...
  computed: {
    ...
    configData() {
      ...
      console.log(list)
      return [
        { itemType: 'cascaderDialog', prop: 'leaseArea', label: '租赁区域', placeholder: '请输入', width: '206px', multiple: true, change: this.changeLeaseArea },
