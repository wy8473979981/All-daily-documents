 ...
 * @LastEditTime: 2021-08-05 19:23:36
-->
<template>
  <div>
    {{ tax }}
    ...
    >
      ...
      <template #beginningDate="scope">
        <el-date-picker
          ...
          :disabled="
            scope.row.beginningDate === listObj.businessAffairs.contBeginDate ||
              disabledDate.includes(scope.row.beginningDate)
          "
      ...
      <template #endingDate="scope">
        <el-date-picker
          ...
          value-format="yyyy-MM-dd"
          :disabled="
            scope.row.endingDate === listObj.businessAffairs.contEndDate ||
              disabledDate.includes(scope.row.endingDate)
          "
      ...
      <template #startingMonthlyTurnover="scope">
        <el-input
          v-model="scope.row.startingMonthlyTurnover"
          placeholder="请输入内容"
        />
      </template>
      ...
      <template #endingMonthlyTurnover="scope">
        <el-input
          v-model="scope.row.endingMonthlyTurnover"
          placeholder="请输入内容"
        />
      </template>
      ...
      <template #monthlyEstimatedTurnover="scope">
        <el-input
          v-model="scope.row.monthlyEstimatedTurnover"
          placeholder="请输入内容"
        />
      </template>
      ...
      <template #commDiscountApply="scope">
        <el-input
          v-model="scope.row.commDiscountApply"
          placeholder="请输入内容"
        />
      </template>
    </ysn-formTable>
    <div class="flex-ju-end mt-20">
      ...
      <ysn-btn v-if="!status" type="info" @click="ok">保存并1返回</ysn-btn>
      <ysn-btn
        v-if="status === '1'"
        type="info"
        @click="isstatus"
...
export default {
  ...
  data() {
    return {
      ...
      //     { startingMonthlyTurnover: '月营业额起', width: '110px', itemType: 'input', hasSlot: true },
      //     { endingMonthlyTurnover: '月营业额止', width: '110px', itemType: 'input', hasSlot: true },
