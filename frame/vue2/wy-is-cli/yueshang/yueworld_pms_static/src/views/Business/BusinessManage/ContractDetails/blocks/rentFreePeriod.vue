 ...
 * @LastEditTime: 2021-07-13 16:31:22
-->
<template>
  <div>
    <ysn-formTable
  ...
  data() {
    return {
      ...
      formTableConfig: [
        ...
        { freeScope: '免租范围', itemType: 'text', list: this.$PUBFN.getOptionsList('globalSearchList'), listName: 'label', listValue: 'value' },
        // { conFeeType: '操作', itemType: '', hasSlot: true },
        { freeStartDate: '免租开始日', itemType: 'text', type: 'date', valueFormat: 'yyyy-MM-dd' },
        { freeEndDate: '免租结束日', itemType: 'text', type: 'date', valueFormat: 'yyyy-MM-dd' },
        { apply: '标准/申请', itemType: 'text', formatter: row => {
          return row.apply + row.Standard
        } }
