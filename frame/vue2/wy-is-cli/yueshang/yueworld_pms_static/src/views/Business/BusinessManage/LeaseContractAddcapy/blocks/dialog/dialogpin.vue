 ...
 * @LastEditTime: 2021-07-26 01:33:40
-->
<template>
  <div>
    <ysn-formTable
    ...
    <div class="flex-ju-end mt-20">
      ...
      <ysn-btn v-if="status==='1'" type="info" @click="isstatus">保存12并返回</ysn-btn>
    </div>
  </div>
</template>
<script>
  ...
  computed: {
    add() {
      if (this.typeStatus.isRentShop === '1') {
        return ['t12', 'name', 'monthlyEstimatedTurnover', 'commDiscountApply', 'leaseArea', 'beginningDate', 'endingDate']
      }
      return ['t12', 'name', 'monthlyEstimatedTurnover', 'commDiscountApply', 'beginningDate', 'endingDate']
    }
  },
  mounted() {
