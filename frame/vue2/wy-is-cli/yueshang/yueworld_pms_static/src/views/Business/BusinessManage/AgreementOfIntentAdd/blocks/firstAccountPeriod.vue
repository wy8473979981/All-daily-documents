 ...
 * @LastEditTime: 2021-08-18 17:05:47
-->
<template>
  <div>
    <ysn-formTable
...
export default {
  ...
  computed: {
    isDisable() {
      // console.log(this.$attrs, '__________')
    ...
    formTableConfig() {
      return [
        ...
        { paymentTotalAmount: '总额', itemType: 'input', disabled: this.isDisable, type: 'money' },
        { tax: '税率', itemType: 'select', list: this.$PUBFN.getOptionsList('globalSearchList'), listName: 'label', listValue: 'value', type: 'rate' },
