 ...
 * @LastEditTime: 2021-07-26 01:33:33
-->
<template>
  <div>
    <ysn-formTable
  ...
  computed: {
    add() {
      if (this.typeStatus.isRentShop === '1') {
        return ['leaseArea', 't12', 'name', 'monthlyEstimatedTurnover', 'class', 'commDiscountApply', 'beginningDate', 'endingDate']
      }
      return ['t12', 'name', 'monthlyEstimatedTurnover', 'class', 'commDiscountApply', 'beginningDate', 'endingDate']
    }
  },
  mounted() {
