 ...
 * @LastEditTime: 2021-07-16 13:51:08
-->
<template>
  <div>
    <el-form ref="rulesForm" :model="currentFormData" label-position="top" size="small" :rules="rule" :disabled="productNoYn">
  ...
  data() {
    return {
      ...
      configData: [ // 新单元表单配置
        ...
        { itemType: 'input', prop: 'intentProtocolName', label: '意向编号', placeholder: '--自动带入--', width: '206px', disabled: true },
        { itemType: 'select', prop: 'tenantName', label: '商家名称', placeholder: '请输入', width: '206px', list: this.$PUBFN.getOptionsList('businessName'), listName: 'label', listValue: 'value' },
        ...
        { itemType: 'input', prop: 'brandFormatName', label: '签约业务', placeholder: '--自动带入--', width: '206px', disabled: true },
        { itemType: 'input', prop: 'programOperateStatus', label: '经营状态', placeholder: '--自动带入--', width: '206px', disabled: true },
        ...
        { itemType: 'select', prop: 'centralizedId', label: '收银类型', placeholder: '请输入', width: '206px', list: this.$PUBFN.getOptionsList('centralized'), listName: 'label', listValue: 'value' },
