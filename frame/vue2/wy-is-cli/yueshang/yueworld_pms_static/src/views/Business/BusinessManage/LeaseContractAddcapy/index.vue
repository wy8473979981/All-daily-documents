 ...
 * @LastEditTime: 2021-08-03 14:49:33
-->
<template>
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query.contNoIntent) {
      groupingSchemeListAdd.brandPositioningDetail({ id: this.$route.query.contNoIntent }).then(res => {
        ...
        console.log(this.formData.fixedRent.add)
        console.log(this.formData.essentialData)
        this.update++
      })
    }
  },
