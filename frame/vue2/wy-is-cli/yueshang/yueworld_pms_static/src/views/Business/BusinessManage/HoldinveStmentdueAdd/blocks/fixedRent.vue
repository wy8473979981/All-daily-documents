 ...
 * @LastEditTime: 2021-07-15 16:20:43
-->
<template>
  <div>
    ...
    <div class="flex-ju-end pr-8 mb-8">
      ...
      >
        ...
        <template #contain>
          <Dialog v-if="algorithmId !=='2'" style="z-index:999" @ok="ok" />
          <DialogEdit v-if="algorithmId === '2'&&commissionType === '1' && isWhether === '0'" />
          <Dialogpin v-if="algorithmId === '2'&&commissionType === '1' && isWhether === '1'" />
          <CommissionDoalog v-if="algorithmId==='2'&& commissionType === '3' && isWhether === '0'" />
          <DialogNo v-if="algorithmId==='2'&& commissionType === '3' && isWhether === '1'" />
        </template>
        <template #btn />
      </ysn-dialog>
    </div>
    ...
    <div v-if="algorithmId==='3'|| algorithmId==='4' || algorithmId==='5'" class="mt-8">
      ...
      <div class="flex-ju-end pr-8 mb-8">
        ...
        >
          ...
          <template #contain>
            <DialogEdit v-if="(algorithmId==='3'||algorithmId==='4'||algorithmId==='5')&&commissionType==='1' &&isWhether==='0' " />
            <Dialogpin v-if="(algorithmId==='3'||algorithmId==='4'||algorithmId==='5')&&commissionType==='1' &&isWhether==='1' " />
            <CommissionDoalog v-if="(algorithmId==='3'||algorithmId==='4'||algorithmId==='5')&&commissionType==='3' &&isWhether==='0' " />
            <DialogNo v-if="(algorithmId==='3'||algorithmId==='4'||algorithmId==='5')&&commissionType==='3' &&isWhether==='1' " />
            <!-- <Dialogpin v-if="(algorithmId === '3'&&commissionType === '1' && isWhether === '1')" />
            <CommissionDoalog v-if="(algorithmId==='4'&& commissionType === '3' && isWhether === '0')" /> -->
            <!-- <DialogNo v-if="algorithmId==='4'&& commissionType === '3' && isWhether === '1'" /> -->
          </template>
          <template #btn />
        </ysn-dialog>
      </div>
  ...
  data() {
    return {
      ...
      publics: [
        ...
        { itemType: 'select', prop: 'tax', label: '税率', placeholder: '请输入', width: '206px', list: this.$PUBFN.getOptionsList('taxIds'), listName: 'label', listValue: 'value' },
