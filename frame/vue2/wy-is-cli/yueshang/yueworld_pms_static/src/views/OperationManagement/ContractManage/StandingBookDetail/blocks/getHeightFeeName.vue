...
<template>
  <div>
    ...
    <el-form ref="rulesForm" :model="currentFormData.fixedFormData" label-position="top" size="small" class="mt-16">
      <ysn-formItem
        :form="currentFormData.fixedFormData"
        :config="fixedFormConfig"
        :column="$attrs.column"
        clearable
        text
      />
    ...
    <el-form
      ref="rulesForm"
      :model="currentFormData.commissionFormData"
      label-position="top"
      size="small"
      class="mt-16"
    >
      <ysn-formItem
        :form="currentFormData.commissionFormData"
        :config="commissionFormConfig"
        :column="$attrs.column"
        clearable
        text
      />
