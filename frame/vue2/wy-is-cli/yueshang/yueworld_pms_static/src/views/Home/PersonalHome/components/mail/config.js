...
export const tableConfig = function() {
  return [
    { addresser: '发件人', sortable: true, isShow: true, width: '90px' },
    { sendType: '类型', sortable: true, isShow: true, minWidth: '80px' },
    { sendTime: '时间', sortable: true, isShow: true, width: '130px' }
  ]
}
