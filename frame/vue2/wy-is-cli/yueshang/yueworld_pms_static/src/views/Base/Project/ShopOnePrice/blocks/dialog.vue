<template>
  <div>
    ...
    >
      <template #contain>
        <ysn-flod :title="form.standardYear" :show-flod="false" hidden-slot />
        ...
        <ysn-flod title="周期性费项标准明细" :show-flod="false" hidden-slot />
        <ysn-formTable
        ...
        <ysn-flod title="变更日志" :show-flod="false" hidden-slot class="mt-12" />
  ...
  data() {
    return {
      ...
      cycleCostTableConfig: [
        ...
        { standardFeeTimeUnit: '费项时间单位', sortable: false, isShow: true, type: 'center' },
