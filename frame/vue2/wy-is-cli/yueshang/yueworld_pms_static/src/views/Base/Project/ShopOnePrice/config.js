...
export const searchConfig = function() {
  return [
    ...
    { itemType: 'select', prop: 'buildingName', label: '', placeholder: '请选择楼栋', width: '200px', list: PUBFN.getOptionsList('floor2') },
    { itemType: 'select', prop: 'floorName', label: '', placeholder: '请选择楼层', width: '200px', list: PUBFN.getOptionsList('floor1') },
    ...
    { itemType: 'select', prop: 'spaceName', label: '', placeholder: '铺位号', width: '200px', list: PUBFN.getOptionsList('projectList') }
...
export const tableConfig = function() {
  return [
    ...
    { spaceName: '铺位号', sortable: true, isShow: true }, // todo:待确定
