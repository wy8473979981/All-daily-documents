...
export const searchConfig = function() {
  return [
    { itemType: 'input', prop: 'fuzzyEnquiry', label: '', placeholder: '请输入楼栋/楼层/多经名称', width: '220px', isSearch: true, isFirst: true },
    ...
    { itemType: 'select', prop: 'diverseName', label: '', placeholder: '请选择多经名称', width: '200px', list: PUBFN.getOptionsList('projectList'), change: this.inputChange },
...
export const tableConfig = function() {
  return [
    ...
    { diverseName: '多经名称', sortable: true, isShow: true },
