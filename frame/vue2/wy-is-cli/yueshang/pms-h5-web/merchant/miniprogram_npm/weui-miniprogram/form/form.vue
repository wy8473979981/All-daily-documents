  ...
  methods: {
    ...
    modelChangeFun(newVal, oldVal) {
      ...
      if (diffObj) {
        ...
        this.showErrorsFun(diffObj, errorMap);
    ...
    showAllErrorsFun(errors) {
      Object.keys(this.newRules).forEach(k => {
        this.showErrorFun(k, errors && errors[k]);
      });
    },

    showErrorsFun(objs, errors) {
      Object.keys(objs).forEach(k => {
        this.showErrorFun(k, errors && errors[k]);
      });
    },

    showErrorFun(prop, error) {
