  ...
  function (module, exports, __webpack_require__) {
    ...
    Component({
      ...
      observers: {
        ...
        container: function container(newVal) {
          if (typeof newVal !== 'function' || !this.height) return;
          this.observerContainer();
        },
        offsetTop: function offsetTop(newVal) {
          if (typeof newVal !== 'number' || !this._attached) return;
          this.initObserver();
        }
      },
      lifetimes: {
        attached: function attached() {
          this._attached = true;
          if (!this.disabled) this.initObserver();
        },
        detached: function detached() {
        ...
        observerContainer: function observerContainer() {
          ...
          this.getContainerRect().then(function (rect) {
            _this3.getRect(target).then(function (contentRect) {
              ...
              _this3._relativeTop = _relativeTop;
              _this3._containerHeight = _containerHeight;
              _this3.containerObserver = containerObserver;
            });
          });
        },
