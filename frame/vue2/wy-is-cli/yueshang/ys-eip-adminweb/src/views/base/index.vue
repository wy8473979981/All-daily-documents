      ...
      <el-table ref="table" :data="tableData" size="mini" show-summary :summary-method="getSummaries" header-row-class-name="table-header" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="单方成本信息(元)" prop="position">
          <el-table-column label="地上土地单方" width="160px" >
            <el-table-column label="原始值" width="80px" prop="original_ground_land_unitprice"/>
            <el-table-column label="分摊值" width="80px" prop="share_ground_land_unitprice"/>
          </el-table-column>
          ...
          <el-table-column label="车库单方" prop="garage_unitprice"/>
        </el-table-column>
        <el-table-column label="总投单方(元)" prop="position">
          <el-table-column label="累计总投" width="100" prop="invest_accumulate_unitprice"/>
          <el-table-column label="新增改造" prop="invest_new_unitprice"/>
          <el-table-column label="合计" prop="invest_total_unitprice">
            <!-- <template slot-scope="scope">
...
<script>
  ...
  import ysTitle from '../../components/ysTitle';
  ...
  export default {
    ...
    methods: {
      ...
      getSummaries(param) {
        return this.$common.tableTotalSum(param, (sums, index)=>{
