  ...
  <div class="list-page">
    <el-row class="tool-bar" type="flex" justify="space-between" align="middle">
      <el-col :span="20" style="display: flex; align-items: center;">
        ...
        <div>
          <label style="width:50px">接收人:</label>
          <el-input
    ...
    <el-table ref="table" :data="tableData" size="mini" border header-row-class-name="table-header" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" width="100"  label="审批编号" prop="approveNo"/>
      <el-table-column align="center" width="100" label="接收人" prop="userName"/>
      <!-- 接收人字段改为推送目标系统 -->
      <!-- <el-table-column align="center" label="推送目标系统" prop="targetAppCd"/>
      <el-table-column align="center" label="推送地址" prop="pushUrl"/>
      ...
      <el-table-column align="center" width="100" label="创建人" prop="createdUserName"/>
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      await approval.findApprovePushPage(params).then(res => {
    ...
    dealDel() {
      ...
      this.$confirm(`确认要删除吗？`).then(() => {
        ...
        approval.delePush(params).then(res => {
