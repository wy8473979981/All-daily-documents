...
<div class="tem-con">
  <div class="list-page">
    <el-row class="tool-bar" type="flex" justify="space-between" align="middle">
      <el-col :span="20" style="display: flex; align-items: center;">
        ...
        <div>
          ...
          <el-select v-model="query.taskType" placeholder="请选择" size="mini" style="max-width:160px">
						<el-option
        ...
        <div>
          <label style="width:50px">责任人:</label>
          <el-input
    ...
    <el-table ref="table" :data="tableData" size="mini" border header-row-class-name="table-header" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center"  label="类型" prop="taskType" show-overflow-tooltip/>
      <el-table-column label="摘要"  prop="subject" show-overflow-tooltip/>
      <el-table-column align="center"  label="责任人" prop="userName" show-overflow-tooltip/>
      <el-table-column label="备注"  prop="remark" show-overflow-tooltip/>
      <el-table-column align="center"  label="创建人" prop="createdUserId" show-overflow-tooltip/>
      ...
      <el-table-column align="center"  label="更新人" prop="updatedUserId" show-overflow-tooltip/>
      <el-table-column align="center"  label="更新时间" prop="updatedDate" show-overflow-tooltip>
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      await approval.getTodoList(params).then(res => {
    ...
    dealDel() {
      ...
      this.$confirm(`确认要删除吗？`).then(() => {
        ...
        approval.deleTodo(params).then(res => {
