...
<template>
  <div class="dialogd">
    ...
    >
      ...
      <div v-if="step == 1" class="step3">
        <div class="table">
          <el-table :data="tableData" style="width: 100%" :header-cell-style="rowClass1">
            <el-table-column prop="num" width="50" label="序号" />
            <el-table-column prop="one" width="70" label="指标" />
