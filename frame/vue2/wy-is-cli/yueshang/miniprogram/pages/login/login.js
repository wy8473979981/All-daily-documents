...
Page({
  ...
  sendVeriCode() {
    ...
    timer = setTimeout(function(){
      ...
      ysRequest({
        url: 'merchantRegist_web/sms/sendSmsVerify.htm',
        method: 'post',
        params: {
  ...
  login() {
    ...
    */
    ...
    ysRequest({
      url: 'merchantRegist_web/regist/userBind.htm',
      method: 'post',
      params: {
        bindTel: _wx.data.phoneNum,
      ...
      succ: res => {
        ...
        if (data.code == "0") {
          ...
          // http://域名 /merchantRegist_web/regist/getCurrentUserInfo.htm
          //checkUserInfo绑定情况
  ...
  onShow: function () {
    ...
    if (!_this.data.openid) {
      wx.login({
        success: (res) => {
          ysRequest({
            url: 'merchantService_web/wechat/getOpenId.htm',
            params: {
              code: res.code
            },
            succ: res => {
    ...
    ysRequest({
      url: 'merchantRegist_web/regist/getAccountByMsg.htm',
      succ: res => {
        _this.setData({
          getAccount: res.data
        })
