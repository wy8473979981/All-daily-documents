...
Page({
  ...
  isReport: function () {
    ...
    wx.request({
      method: 'POST',
      url: `${main_config.baseUrl}merchantOpen_web/sale/month/report.htm`,
      data: {
        "version": "1.0",
  ...
  category: function () {
    ...
    wx.request({
      method: 'POST',
      url: `${main_config.baseUrl}merchantOpen_web/sale/day/list.htm`,
      data: {
        "version": "1.0",
        "timestamp": new Date().getTime(),
        "sign": main_config.sign,
  ...
  confirm: function (e) {
     ...
     * 待开发
     * 
     * url: 'merchantOpen_web/sale/report.htm'
     */
  },
  /**
   * 生命周期函数--监听页面加载
