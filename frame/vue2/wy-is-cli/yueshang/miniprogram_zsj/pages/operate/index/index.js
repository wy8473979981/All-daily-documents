...
Page({
  ...
  salesChart: function (e) {
    ...
    wx.request({
      method: 'POST',
      url: `${main_config.baseUrl}merchantOpen_web/sale/salesChart.htm`,
      data: {
        "version": "1.0",
  ...
  getData: function (e) {
    ...
    wx.request({
      method: 'POST',
      url: `${main_config.baseUrl}finance_web/sale/day/record.htm`,
      data: {
  ...
  detail: function (e) {
    let saleYmd = e.currentTarget.dataset.item.saleYm
