...
export const columns: TableColumnDef[] = [
  ...
  { prop: 'versionNumber', label: '版本号', minWidth: '100px', formatter: (row: any, column: any, cellValue: string, index: number) => `v${cellValue}.0` },
  { prop: 'fileName', label: '文件名', minWidth: '250px' },
