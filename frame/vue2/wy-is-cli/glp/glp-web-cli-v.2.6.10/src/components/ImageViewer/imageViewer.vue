<template>
  <transition name="viewer-fade">
    <div class="el-image-viewer__wrapper" :style="{ 'z-index': zIndex }">
      ...
      <!-- CLOSE -->
      <span class="el-image-viewer__btn el-image-viewer__close c-w" @click="hide">
        <i class="el-icon-circle-close"></i>
      </span>
      <!-- ARROW -->
      <template v-if="!isSingle">
        <span
          class="el-image-viewer__btn el-image-viewer__prev  c-w"
        ...
        <span
          class="el-image-viewer__btn el-image-viewer__next  c-w"
    ...
    currentUrl:{
      handler:function (val) {
        let index=this.urlList.findIndex(item => {
          return item==this.currentUrl && this.currentUrl;
        });
