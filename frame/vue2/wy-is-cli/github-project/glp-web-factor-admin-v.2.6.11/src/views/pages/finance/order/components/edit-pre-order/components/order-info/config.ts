...
export const debtColumns: TableColumnDef[] = [
  ...
  { prop: 'endDate', label: '到期日明细', formatter: formatter('date') },
...
function contractFormDefFn (step?: number): Array<FieldDef | GridFieldDef> {
  ...
  return [
    ...
    { type: 'date', model: 'basicContractExpireDate', label: '基础合同到期日', dependOn: 'form.noFixed === "0"', options: { type: 'date', format: datetime }, rules },
