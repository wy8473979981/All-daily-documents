        ...
        <el-row :gutter="32">
          <el-col :span="8">
            <el-form-item label="账户户名" prop="returnBankId" :rules="[{ required: true, message: '必填', trigger: 'blur'}]">
              <el-select v-model="relaitonForm.returnBankId" placeholder="请选择账户名称" clearable @change="onChangeReturnBankId">
                <el-option
        ...
        <el-row :gutter="32">
          <el-col :span="8">
            <el-form-item label="账户户名" prop="ebankId" :rules="[{ required: true, message: '必填', trigger: 'blur'}]">
              <el-select v-model="relaitonForm.ebankId" clearable @change="onChangeEbankId" placeholder="请选择账户户名">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="开户行" prop="ebindBankName" :rules="[{ required: true, message: '必填', trigger: 'blur'}]">
              <el-input v-model="relaitonForm.ebindBankName" clearable :class="[$style.width100]" placeholder="请填写开户行"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="账户账号" prop="ebankNo" :rules="[{ required: true, message: '必填', trigger: 'blur'}]">
              <el-input v-model="relaitonForm.ebankNo" clearable :class="[$style.width100]" placeholder="请填写账户账号"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </glp-section>
