...
export const baseFormDefs: Array<FieldDef | GridFieldDef> = [
  ...
  { type: 'text', model: 'enterpriseEmail', label: '邮箱', rules: [{ validator: validator('email'), trigger: 'blur', sep: ',' }] },
...
export const contractFormDefs: FieldDef[] = [
  ...
  { type: 'text', model: 'contactEmail', label: '联系人邮箱', rules: [{ validator: validator('email'), trigger: 'blur', sep: ',' }] }
]
