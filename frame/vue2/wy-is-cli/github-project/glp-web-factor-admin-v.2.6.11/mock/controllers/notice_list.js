...
export default class notice_list extends Controller {
  @RequestMapping({ url: '/backend/base/notice-list/paged', method: 'post' })
  pagedQuery (req, res, context) {
    return delayResp(new Page(req, this.collection.find()))
  }

  @RequestMapping({ url: '/backend/base/notice-list/paged/:id', method: 'get' })
  get (req, res, context) {
