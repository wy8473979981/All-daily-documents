...
import getDerivedStateFromProps from "./pages/getDerivedStateFromProps/getDerivedStateFromProps";
import getSnapshotBeforeUpdate from "./pages/getSnapshotBeforeUpdate/getSnapshotBeforeUpdate";
    ...
    return (
      <>
        ...
        <Switch>
          ...
          <Route path="/getDerivedStateFromProps" exact component={getDerivedStateFromProps}></Route>
          <Route path="/getSnapshotBeforeUpdate" exact component={getSnapshotBeforeUpdate}></Route>
